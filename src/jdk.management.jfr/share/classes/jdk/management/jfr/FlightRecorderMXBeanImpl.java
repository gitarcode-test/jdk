...
final class FlightRecorderMXBeanImpl extends StandardEmitterMBean
    implements FlightRecorderMXBean, NotificationEmitter {
  ...
  FlightRecorderMXBeanImpl() {
    super(
        ...
        true,
        new NotificationBroadcasterSupport(createNotificationInfo()));
  }
  ...
  public List<EventTypeInfo> getEventTypes() {
    ...
    List<EventType> eventTypes =
        AccessController.doPrivileged(
            new PrivilegedAction<List<EventType>>() {
              @Override
  ...
  @Override
  public void setRecordingSettings(long recording, Map<String, String> settings)
  ...
  @Override
  public void setPredefinedConfiguration(long recording, String configurationName)
      throws IllegalArgumentException {
  ...
  @Override
  public void setRecordingOptions(long recording, Map<String, String> options)
      throws IllegalArgumentException {
    ...
    for (Map.Entry<String, String> entry : ops.entrySet()) {
      ...
      if (!(key instanceof String)) {
        throw new IllegalArgumentException(
            "Option key must not be null, or other type than " + String.class);
      }
      if (!OPTIONS.contains(key)) {
        throw new IllegalArgumentException(
            "Unknown recording option: " + key + ". Valid options are " + OPTIONS + ".");
      }
    ...
    setOption(
        ...
        OPTION_DESTINATION,
        null,
        x -> MBeanUtils.destination(r, x),
        x -> setOptionDestination(r, x));
  }
  ...
  private static <T, U> void setOption(
    ...
    try {
      ...
      throw new IllegalArgumentException(
          "Not a valid value for option '" + name + "'. " + iae.getMessage());
    }
  }
  ...
  private static void setOptionDestination(Recording recording, String destination) {
    try {
      ...
      IllegalArgumentException iae =
          new IllegalArgumentException("Not a valid destination " + destination);
      iae.addSuppressed(e);
      throw iae;
    }
  }

  private static <T, U> void validateOption(
      Map<String, String> options, String name, Function<String, U> validator) {
    try {
      String v = options.get(name);
      if (v == null) {
  ...
  private FlightRecorder getRecorder() throws SecurityException {
    ...
    synchronized (streamHandler) {
      if (recorder == null) {
        recorder =
            AccessController.doPrivileged(
                new PrivilegedAction<FlightRecorder>() {
                  @Override
  ...
  private static MBeanNotificationInfo[] createNotificationInfo() {
    ...
    String description =
        "Notifies if the RecordingState has changed for one of the recordings, for example if a"
  ...
  private Notification createNotification(Recording recording) {
    try {
      ...
      return new AttributeChangeNotification(
          ...
          "Recording " + recording.getName() + " is " + recording.getState(),
      ...
      throw new RuntimeException(
          "Could not create notification for FlightRecorderMXBean. " + e.getMessage(), e);
    }
  }
}
