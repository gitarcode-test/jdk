 ...
 *
 * <p>This exception is only used to capture a user-facing error message. The message supplier is
 * accepted not to control when to obtain a message, but to abstract how to obtain it.
 */
