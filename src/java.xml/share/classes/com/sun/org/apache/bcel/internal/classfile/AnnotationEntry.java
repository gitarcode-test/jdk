...
public class AnnotationEntry implements Node {
  ...
  public static AnnotationEntry read(
      final DataInput input, final ConstantPool constantPool, final boolean isRuntimeVisible)
      throws IOException {
    final AnnotationEntry annotationEntry =
        new AnnotationEntry(input.readUnsignedShort(), constantPool, isRuntimeVisible);
    ...
    for (int i = 0; i < numElementValuePairs; i++) {
      annotationEntry.elementValuePairs.add(
          new ElementValuePair(
              ...
              ElementValue.readElementValue(input, constantPool),
              constantPool));
    }
  ...
  public AnnotationEntry(
      final int typeIndex, final ConstantPool constantPool, final boolean isRuntimeVisible) {
  ...
  /**
   * Called by objects that are traversing the nodes of the tree implicitly defined by the contents
