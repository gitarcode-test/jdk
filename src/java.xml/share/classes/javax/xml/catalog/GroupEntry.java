...
class GroupEntry extends BaseEntry {
  ...
  */
  ...
  /**
   * Sets the prefer property. If the value is null or empty, or any String other than the defined,
   ...
   *
   * <p>prefer "system": attempts to resolve with a system entry; attempts to resolve with a public
   * entry when only publicId is specified.
   *
   * <p>prefer "public": attempts to resolve with a system entry; attempts to resolve with a public
   * entry if no matching system entry is found.
   *
