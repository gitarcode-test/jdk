...
class CatalogImpl extends GroupEntry implements Catalog {
  ...
  */
  ...
  /**
   * Sets the resolve property. If the value is null or empty, or any String other than the defined,
   * it will be assumed as the default value.
   *
   ...
   *
   * @param parent the parent catalog for the alternative catalogs to be loaded. It will be null if
   *     the ones to be loaded are from the input list.
