 ...
 *
 * <p><strong>This is NOT part of any supported API. If you write code that depends on this, you do
 * so at your own risk. This code and its internal interfaces are subject to change or deletion
 * without notice.</strong>
 */
record RelevantJavacOptions(
    List<String> forProgramCompilation, List<String> forSubsequentCompilations) {

  /**
   * Returns the subset of the runtime arguments that are relevant to {@code javac}. Generally, the
   * relevant options are those for setting paths and for configuring the module system.
   *
