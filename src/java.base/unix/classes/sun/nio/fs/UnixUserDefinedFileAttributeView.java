...
abstract class UnixUserDefinedFileAttributeView extends AbstractUserDefinedFileAttributeView {
  ...
  private byte[] nameAsBytes(UnixPath file, String name) throws IOException {
    ...
    if (bytes.length > maxNameLength()) {
      throw new FileSystemException(
          file.getPathForExceptionMessage(), null, "'" + name + "' is too big");
    }
    return bytes;
  }
  ...
  public List<String> list() throws IOException {
    ...
    try {
      ...
      throw new FileSystemException(
          ...
          null,
          "Unable to get list of extended attributes: " + x.getMessage());
    } finally {
      close(fd, e -> null);
    }
  }
  ...
  public int size(String name) throws IOException {
    ...
    try {
      ...
      throw new FileSystemException(
          file.getPathForExceptionMessage(),
          null,
          "Unable to get size of extended attribute '" + name + "': " + x.getMessage());
    } finally {
      close(fd, e -> null);
    }
  }
  ...
  private int read(String name, long address, int rem) throws IOException {
    ...
    try {
      ...
      throw new FileSystemException(
          file.getPathForExceptionMessage(),
          null,
          "Error reading extended attribute '" + name + "': " + msg);
    } finally {
      close(fd, e -> null);
    }
  }
  ...
  private void write(String name, long address, int rem) throws IOException {
    ...
    try {
      ...
      throw new FileSystemException(
          file.getPathForExceptionMessage(),
          null,
          "Error writing extended attribute '" + name + "': " + x.getMessage());
    } finally {
      close(fd, e -> null);
    }
  }
  ...
  public void delete(String name) throws IOException {
    ...
    try {
      ...
      throw new FileSystemException(
          file.getPathForExceptionMessage(),
          null,
          "Unable to delete extended attribute '" + name + "': " + x.getMessage());
    } finally {
      close(fd, e -> null);
    }
  }
   ...
   *
   * @param ofd file descriptor for source file
   * @param nfd file descriptor for target file
   */
