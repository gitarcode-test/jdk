...
abstract class ShellCustomAction {
  ...
  static void mergeReplacementData(Map<String, String> target, Map<String, String> newValues) {
    ...
    for (var kvp : newValues.entrySet()) {
      ...
      if (existingValue != null) {
        ...
        } else if (!newValue.isEmpty() && !newValue.equals(existingValue)) {
          throw new IllegalArgumentException(
              String.format("Key [%s] value mismatch", kvp.getKey()));
        }
      }
    }
  }
