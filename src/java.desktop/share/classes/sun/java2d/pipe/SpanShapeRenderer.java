...
/**
 * This class is used to convert raw geometry into a span iterator object using a simple flattening
 * polygon scan converter. The iterator can be passed on to special SpanFiller loops to perform the
 * actual rendering.
 */
