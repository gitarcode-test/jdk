...
/**
 * A WindowWaiter is a utility class used to look or wait for Windows. It contains methods to search
 * for a Window among the currently showing Windows as well as methods that wait for a Window to
 * show within an allotted time period.
 *
 * <p>Searches and waits always involve search criteria applied by a ComponentChooser instance.
 * Searches and waits can both be restricted to windows owned by a given window. <br>
 * Timeouts used: <br>
...
public class WindowWaiter extends Waiter<Window, Void> implements Timeoutable {
  ...
  /**
   * Searches for a window. The search proceeds among the currently showing windows for the {@code
   * index+1}'th window that is both owned by the {@code java.awt.Window} {@code owner} and that
   * meets the criteria defined and applied by the {@code ComponentChooser} parameter.
   *
   ...
   * @param index The ordinal index of the window in the set of currently displayed windows with the
   *     proper window ownership and a suitable title. The first index is 0.
   * @return a reference to the {@code index+1}'th window that is showing, has the proper window
   *     ownership, and that meets the search criteria. If there are fewer than {@code index+1}
   *     windows, a {@code null} reference is returned.
   */
  ...
  /**
   * Searches for a window. Search among the currently showing windows for the first that is both
   * owned by the {@code java.awt.Window} {@code owner} and that meets the search criteria applied
   * by the {@code ComponentChooser} parameter.
   *
   * @param owner The owner window of the windows to be searched.
   * @param cc A component chooser used to define and apply the search criteria.
   * @return a reference to the first window that is showing, has a proper owner window, and that
   *     meets the search criteria. If no such window can be found, a {@code null} reference is
   *     returned.
   */
  ...
  /**
   * Searches for a window. The search proceeds among the currently showing windows for the {@code
   * index+1}'th window that meets the criteria defined and applied by the {@code ComonentChooser}
   * parameter.
   *
   * @param cc A component chooser used to define and apply the search criteria.
   * @param index The ordinal index of the window in the set of currently displayed windows. The
   *     first index is 0.
   * @return a reference to the {@code index+1}'th window that is showing and that meets the search
   *     criteria. If there are fewer than {@code index+1} windows, a {@code null} reference is
   *     returned.
   */
  ...
  /**
   * Searches for a window. Search among the currently showing windows for one that meets the search
   * criteria applied by the {@code ComponentChooser} parameter.
   *
   * @param cc A component chooser used to define and apply the search criteria.
   * @return a reference to the first window that is showing and that meets the search criteria. If
   *     no such window can be found, a {@code null} reference is returned.
   */
  ...
  public void setTimeouts(Timeouts timeouts) {
    ...
    times.setTimeout(
        "Waiter.AfterWaitingTime", timeouts.getTimeout("WindowWaiter.AfterWindowTimeout"));
  ...
  /**
   * Action producer--get a window. Get a window. The search uses constraints on window ownership,
   * ordinal index, and search criteria defined by an instance of {@code
   * org.netbeans.jemmy.ComponentChooser}.
   *
   * @param obj Not used.
   * @return the window waited upon. If a window cannot be found then a {@code null} reference is
   *     returned.
  ...
  /**
   * Waits for a window to show. Wait for the {@code index+1}'th window that meets the criteria
   * defined and applied by the {@code ComonentChooser} parameter to show up.
   *
   * @param ch A component chooser used to define and apply the search criteria.
   * @param index The ordinal index of the window in the set of currently displayed windows. The
   *     first index is 0.
   * @return a reference to the {@code index+1}'th window that shows and that meets the search
   *     criteria. If fewer than {@code index+1} windows show up in the allotted time period then a
  ...
  /**
   * Waits for a window to show. Wait for a window that meets the search criteria applied by the
   * {@code ComponentChooser} parameter to show up.
   *
   * @param ch A component chooser used to define and apply the search criteria.
   * @return a reference to the first window that shows and that meets the search criteria. If no
   *     such window can be found within the time period allotted, a {@code null} reference is
   *     returned.
   * @throws TimeoutExpiredException
   * @see #actionProduced(Object)
   * @exception InterruptedException
  ...
  /**
   * Waits for a window to show. Wait for the {@code index+1}'th window to show that is both owned
   * by the {@code java.awt.Window} {@code o} and that meets the criteria defined and applied by the
   ...
   * @param index The ordinal index of the window in the set of currently displayed windows with the
   *     proper window ownership and a suitable title. The first index is 0.
   * @return a reference to the {@code index+1}'th window to show that has the proper window
   *     ownership, and that meets the search criteria. If there are fewer than {@code index+1}
   *     windows, a {@code null} reference is returned.
   * @throws TimeoutExpiredException
   * @see #actionProduced(Object)
  ...
  /**
   * Waits for a window to show. Wait for the first window to show that is both owned by the {@code
   * java.awt.Window} {@code o} and that meets the criteria defined and applied by the {@code
   * ComponentChooser} parameter.
   *
   * @param o The owner window of all the windows to be searched.
   * @param ch A component chooser used to define and apply the search criteria.
   * @return a reference to the first window to show that has the proper window ownership, and that
   *     meets the search criteria. If there is no such window, a {@code null} reference is
   *     returned.
   * @throws TimeoutExpiredException
   * @see #actionProduced(Object)
   * @exception InterruptedException
  ...
  /**
   * Wait till the count of windows which meet the search criteria becomes equal to count.
   *
   * @param ch a component chooser used to define and apply the search criteria.
  ...
  public static void waitWindowCount(Window owner, ComponentChooser ch, int count)
      throws InterruptedException {
    Waiter<String, Void> stateWaiter =
        new Waiter<>(
            new Waitable<String, Void>() {
              @Override
              ...
              public String getDescription() {
                return "Wait till the count of windows matching the criteria "
                    + "specified by ComponentChooser reaches :"
                    + count;
              }
  ...
  /**
   * Counts all the windows owned by the owner window which match the criterion specified by
   * component chooser.
   *
   * @param owner The owner window of all the windows to be checked
   * @param ch A component chooser used to define and apply the search criteria
  ...
  public static int countWindows(Window owner, ComponentChooser ch) {
    return new QueueTool()
        .invokeAndWait(
            new QueueTool.QueueAction<Integer>(null) {
  ...
  /**
   * Counts all the windows which match the criterion specified by component chooser.
   *
   * @param ch A component chooser used to define and apply the search criteria
   * @return the number of matched windows
   */
  ...
  protected String getTimeoutExpiredMessage(long timeSpent) {
    return ("Window \""
        + chooser.getDescription()
        + "\" has not been opened in "
        + timeSpent
        + " milliseconds");
  }
