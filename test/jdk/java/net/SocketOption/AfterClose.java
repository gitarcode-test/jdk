...
public class AfterClose {
  ...
  @Test(dataProvider = "socketOptionValues")
  public <T> void closedSocketAdapter(SocketOption<T> option, List<T> values) throws IOException {
  ...
  @Test(dataProvider = "datagramSocketOptionValues")
  public <T> void closedDatagramAdapter(SocketOption<T> option, List<T> values) throws IOException {
    DatagramSocket datagramSocket = createClosedBoundDatagramSocket();
    for (int i = 0; i < 3; i++)
      ;
    {
