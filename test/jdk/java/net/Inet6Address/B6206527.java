 ...
 * @library /test/lib
 * @build jdk.test.lib.NetworkConfiguration jdk.test.lib.Platform
 * @run main B6206527
 */
import java.net.*;
import java.util.*;
...
public class B6206527 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    addr = (Inet6Address) InetAddress.getByAddress(addr.getAddress());
  ...
  public static Inet6Address getLocalAddr() throws Exception {
    Optional<Inet6Address> oaddr =
        NetworkConfiguration.probe().ip6Addresses().filter(a -> a.isLinkLocalAddress()).findFirst();
