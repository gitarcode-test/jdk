...
public class SetGetSendBufferSize {
  ...
  static DatagramSocketSupplier supplier(DatagramSocketSupplier supplier) {
    return supplier;
  }
  ...
  public void testSetInvalidBufferSize(String name, DatagramSocketSupplier supplier)
      throws IOException {
  ...
  @Test(dataProvider = "invariants")
  public void testSetAndGetBufferSize(String name, DatagramSocketSupplier supplier)
      throws IOException {
  ...
  @Test(dataProvider = "invariants")
  public void testInitialSendBufferSize(String name, DatagramSocketSupplier supplier)
      throws IOException {
    if (Platform.isOSX()) {
      try (var socket = supplier.open()) {
  ...
  @Test(dataProvider = "invariants")
  public void testSetGetAfterClose(String name, DatagramSocketSupplier supplier)
      throws IOException {
