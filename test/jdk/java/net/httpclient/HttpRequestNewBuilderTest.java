...
public class HttpRequestNewBuilderTest {
  ...
  List<NamedAssertion> REQUEST_ASSERTIONS =
      List.of(
          ...
          new NamedAssertion(
              "expectContinue", (r1, r2) -> assertEquals(r1.expectContinue(), r2.expectContinue())),
          new NamedAssertion(
              "method",
              (r1, r2) -> {
  ...
  public Object[][] variants() {
    return new Object[][] {
      ...
      {
        HttpRequest.newBuilder(URI.create("https://timeout-1/"))
            .timeout(Duration.ofSeconds(30))
            .build()
      },
      {
        HttpRequest.newBuilder(URI.create("https://header-1/"))
            .header("testName1", "testValue1")
            .build()
      },
      {
        HttpRequest.newBuilder(URI.create("https://header-2/"))
            .headers("testName1", "testValue1", "a", "1", "b", "2", "c", "3", "d", "4")
            .build()
      },
      {
      ...
      },
      {
        HttpRequest.newBuilder(URI.create("https://header-4/"))
            .headers("a", "1", "b", "2", "c", "3", "d", "4", "testName1", "testValue1")
            .build()
      },
      {
      ...
      {
        HttpRequest.newBuilder(URI.create("https://method-3/"))
            .POST(HttpRequest.BodyPublishers.ofString("testData"))
            .build()
      },
      {
        HttpRequest.newBuilder(URI.create("https://method-4/"))
            .PUT(HttpRequest.BodyPublishers.ofString("testData"))
            .build()
      },
      // method w/body
      {
        HttpRequest.newBuilder(URI.create("https://method-5/"))
            .method("GET", HttpRequest.BodyPublishers.ofString("testData"))
            .build()
      },
      {
        HttpRequest.newBuilder(URI.create("https://method-6/"))
            .method("DELETE", HttpRequest.BodyPublishers.ofString("testData"))
            .build()
      },
      {
        HttpRequest.newBuilder(URI.create("https://method-7/"))
            .method("POST", HttpRequest.BodyPublishers.ofString("testData"))
            .build()
      },
      {
        HttpRequest.newBuilder(URI.create("https://method-8/"))
            .method("PUT", HttpRequest.BodyPublishers.ofString("testData"))
            .build()
      },
      // method w/o body
      {
        HttpRequest.newBuilder(URI.create("https://method-9/"))
            .method("GET", HttpRequest.BodyPublishers.noBody())
            .build()
      },
      {
        HttpRequest.newBuilder(URI.create("https://method-10/"))
            .method("DELETE", HttpRequest.BodyPublishers.noBody())
            .build()
      },
      {
        HttpRequest.newBuilder(URI.create("https://method-11/"))
            .method("POST", HttpRequest.BodyPublishers.noBody())
            .build()
      },
      {
        HttpRequest.newBuilder(URI.create("https://method-12/"))
            .method("PUT", HttpRequest.BodyPublishers.noBody())
            .build()
      },
      // user defined methods w/ & w/o body
      {
        HttpRequest.newBuilder(URI.create("https://method-13/"))
            .method("TEST", HttpRequest.BodyPublishers.noBody())
            .build()
      },
      {
        HttpRequest.newBuilder(URI.create("https://method-14/"))
            .method("TEST", HttpRequest.BodyPublishers.ofString("testData"))
            .build()
      },
      {
        HttpRequest.newBuilder(URI.create("https://all-fields-1/"))
            .GET()
            .expectContinue(true)
            .version(HTTP_2)
  ...
  void assertBodyPublisherEqual(HttpRequest r1, HttpRequest r2) {
    if (r1.bodyPublisher().isPresent()) {
      ...
      final class TestSubscriber implements Flow.Subscriber<ByteBuffer> {
        ...
        TestSubscriber(BodySubscriber<String> s) {
          this.s = s;
        }
        ...
        public void onNext(ByteBuffer item) {
          s.onNext(List.of(item));
        }

        @Override
        public void onError(Throwable throwable) {
          fail("TestSubscriber failed");
        }
  ...
  void testBodyPublisher(String methodName, HttpRequest request) {
    ...
    var r1 =
        HttpRequest.newBuilder(request, (n, v) -> true).method(methodName, noBodyPublisher).build();
  ...
  public void testGET(HttpRequest request) {
    var r = HttpRequest.newBuilder(request, (n, v) -> true).GET().build();
  ...
  public void testDELETE(HttpRequest request) {
    var r = HttpRequest.newBuilder(request, (n, v) -> true).DELETE().build();
  ...
  public void testRemoveSingleHeaderValue(HttpRequest request) {
    ...
    BiPredicate<String, String> filter =
        (n, v) -> !(n.equalsIgnoreCase("testName1") && v.equals("testValue1"));
  ...
  public void testRemoveMultipleHeaders(HttpRequest request) {
    BiPredicate<String, String> isTestName1Value1 =
        (n, v) -> n.equalsIgnoreCase("testName1") && v.equals("testValue1");
    BiPredicate<String, String> isTestName2Value2 =
        (n, v) -> n.equalsIgnoreCase("testName2") && v.equals("testValue2");
    var filter = (isTestName1Value1.or(isTestName2Value2)).negate();

    var r = HttpRequest.newBuilder(request, filter).build();
    assertEquals(r.headers().map(), HttpHeaders.of(request.headers().map(), filter).map());

    BiPredicate<String, String> filter1 =
        (n, v) ->
            !(n.equalsIgnoreCase("testName1")
                && (v.equals("testValue1") || v.equals("testValue2")));
  ...
  public void testHeaderExample() {
    var request =
        HttpRequest.newBuilder(URI.create("https://example/")).header("Foo-Bar", "baz").build();
