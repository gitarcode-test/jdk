...
public class DriverManagerModuleTests {
  ...
  /**
   * Validate JDBC drivers as modules will be accessible. One driver will be loaded and registered
   * via the service-provider loading mechanism. The other driver will need to be explictly loaded
   *
  ...
  /**
   * Validate that a Connection can be obtained from a JDBC driver which is a module and loaded via
