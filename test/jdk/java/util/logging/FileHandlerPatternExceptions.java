...
public class FileHandlerPatternExceptions {
  ...
  /**
   * We will test null/empty pattern in two configurations. UNSECURE: No security manager. SECURE:
   * With the security manager present - and the required permissions granted.
   */
