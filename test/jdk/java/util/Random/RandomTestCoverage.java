...
public class RandomTestCoverage {
      ...
      case "SecureRandom" -> {
        try {
          ...
          throw new AssertionError(
              "RandomGeneratorFactory.create(long) was expected"
    ...
    switch (factory.name()) {
      ...
      case "Random", "SplittableRandom" -> {
        try {
          ...
          throw new AssertionError(
              "RandomGeneratorFactory.create(byte[]) was expected"
                  + "to throw UnsupportedOperationException for "
                  + factory.name()
                  + " but didn't");
        } catch (UnsupportedOperationException ignored) {
  ...
  public static void main(String[] args) throws Throwable {
    ...
    RandomGeneratorFactory.all().forEach(RandomTestCoverage::checkPredicates);
