...
public class IteratorMicroBenchmark {
  ...
  static List<Integer> makeSubList(
      List<Integer> elements, UnaryOperator<List<Integer>> copyConstructor) {
    ...
    return copyConstructor.apply(padded).subList(frontPorch, frontPorch + elements.size());
  }
  ...
  void run() throws Throwable {
    ...
    final ThreadLocalRandom rnd = ThreadLocalRandom.current();
    for (int i = 0; i < size; i++) al.add(rnd.nextInt(size));
  ...
  Stream<Job> jobs(Collection<Integer> x) {
    return concatStreams(
        collectionJobs(x),
        (isMutable(x)) ? mutableCollectionJobs(x) : Stream.empty(),
        (x instanceof Deque) ? dequeJobs((Deque<Integer>) x) : Stream.empty(),
        (x instanceof List) ? listJobs((List<Integer>) x) : Stream.empty(),
        (x instanceof List && isMutable(x)) ? mutableListJobs((List<Integer>) x) : Stream.empty());
  }
  ...
  Stream<Job> collectionJobs(Collection<Integer> x) {
    ...
    return Stream.of(
        ...
        new Job(klazz + " containsAll") {
          public void work() throws Throwable {
            int[] sum = new int[1];
            Collection<Object> sneakyAdderCollection = Collections.singleton(sneakyAdder(sum));
            for (int i = 0; i < iterations; i++) {
              sum[0] = 0;
              if (x.containsAll(sneakyAdderCollection)) throw new AssertionError();
              check.sum(sum[0]);
            }
          }
        },
        ...
        new Job(klazz + " toArray()") {
          public void work() throws Throwable {
            ...
            for (int i = 0; i < iterations; i++) {
              sum[0] = 0;
              for (Object o : x.toArray()) sum[0] += (Integer) o;
              check.sum(sum[0]);
            }
          }
        },
        ...
        new Job(klazz + " toArray(empty)") {
          public void work() throws Throwable {
            ...
            for (int i = 0; i < iterations; i++) {
              sum[0] = 0;
              for (Integer o : x.toArray(empty)) sum[0] += o;
              check.sum(sum[0]);
            }
          }
        },
        ...
        new Job(klazz + " stream().collect") {
          public void work() throws Throwable {
            for (int i = 0; i < iterations; i++) {
              check.sum(x.stream().collect(summingInt(e -> e)));
            }
          }
        },
        new Job(klazz + " stream()::iterator") {
          public void work() throws Throwable {
            ...
            for (int i = 0; i < iterations; i++) {
              sum[0] = 0;
              for (Integer o : (Iterable<Integer>) x.stream()::iterator) sum[0] += o;
              check.sum(sum[0]);
            }
          }
        },
        ...
        new Job(klazz + " parallelStream().collect") {
          public void work() throws Throwable {
            for (int i = 0; i < iterations; i++) {
              check.sum(x.parallelStream().collect(summingInt(e -> e)));
            }
          }
        },
        new Job(klazz + " parallelStream()::iterator") {
          public void work() throws Throwable {
            ...
            for (int i = 0; i < iterations; i++) {
              sum[0] = 0;
              for (Integer o : (Iterable<Integer>) x.parallelStream()::iterator) sum[0] += o;
              check.sum(sum[0]);
            }
          }
        });
    ...
    return Stream.of(
        ...
        new Job(klazz + " indexOf") {
          public void work() throws Throwable {
            ...
            for (int i = 0; i < iterations; i++) {
              sum[0] = 0;
              if (x.indexOf(sneakyAdder) != -1) throw new AssertionError();
              check.sum(sum[0]);
            }
          }
        },
        new Job(klazz + " lastIndexOf") {
          public void work() throws Throwable {
            ...
            for (int i = 0; i < iterations; i++) {
              sum[0] = 0;
              if (x.lastIndexOf(sneakyAdder) != -1) throw new AssertionError();
              check.sum(sum[0]);
            }
          }
        },
        new Job(klazz + " equals") {
          public void work() throws Throwable {
            ...
            for (int i = 0; i < iterations; i++) {
              if (!x.equals(copy)) throw new AssertionError();
            }
          }
        },
        new Job(klazz + " hashCode") {
          public void work() throws Throwable {
            ...
            for (int i = 0; i < iterations; i++) {
              if (x.hashCode() != hashCode) throw new AssertionError();
            }
          }
        });
  }
