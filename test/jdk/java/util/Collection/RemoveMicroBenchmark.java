...
public class RemoveMicroBenchmark {
  ...
  static List<Integer> makeSubList(List<Integer> list) {
    ...
    for (int i = size; i-- > 0; ) list.add(rnd.nextInt());
  ...
  Stream<Job> jobs(Collection<Integer> x) {
    return concatStreams(
        ...
        (x instanceof Queue) ? queueJobs((Queue<Integer>) x) : Stream.empty(),
        ...
        new Job(klazz + " poll()") {
          public void work() throws Throwable {
            ...
            for (int i = 0; i < iterations; i++) {
              sum[0] = 0;
              x.addAll(elements);
              for (Integer e; (e = x.poll()) != null; ) sum[0] += e;
              check.sum(sum[0]);
            }
          }
        });
        ...
        new Job(klazz + " pollFirst()") {
          public void work() throws Throwable {
            ...
            for (int i = 0; i < iterations; i++) {
              sum[0] = 0;
              x.addAll(elements);
              for (Integer e; (e = x.pollFirst()) != null; ) sum[0] += e;
              check.sum(sum[0]);
            }
          }
        },
        new Job(klazz + " pollLast()") {
          public void work() throws Throwable {
            ...
            for (int i = 0; i < iterations; i++) {
              sum[0] = 0;
              x.addAll(elements);
              for (Integer e; (e = x.pollLast()) != null; ) sum[0] += e;
              check.sum(sum[0]);
            }
          }
        });
        ...
        new Job(klazz + " timed poll()") {
          public void work() throws Throwable {
            ...
            for (int i = 0; i < iterations; i++) {
              sum[0] = 0;
              x.addAll(elements);
              for (Integer e; (e = x.poll(0L, TimeUnit.DAYS)) != null; ) sum[0] += e;
              check.sum(sum[0]);
            }
          }
        },
        ...
        new Job(klazz + " timed pollFirst()") {
          public void work() throws Throwable {
            ...
            for (int i = 0; i < iterations; i++) {
              sum[0] = 0;
              x.addAll(elements);
              for (Integer e; (e = x.pollFirst(0L, TimeUnit.DAYS)) != null; ) sum[0] += e;
              check.sum(sum[0]);
            }
          }
        },
        new Job(klazz + " timed pollLast()") {
          public void work() throws Throwable {
            ...
            for (int i = 0; i < iterations; i++) {
              sum[0] = 0;
              x.addAll(elements);
              for (Integer e; (e = x.pollLast(0L, TimeUnit.DAYS)) != null; ) sum[0] += e;
              check.sum(sum[0]);
            }
          }
        });
