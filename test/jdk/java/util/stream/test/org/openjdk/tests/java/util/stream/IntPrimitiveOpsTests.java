...
public class IntPrimitiveOpsTests {
  ...
  public void testFlags() {
    ...
    assertFalse(IntStream.of(1, 10).boxed().spliterator().hasCharacteristics(Spliterator.SORTED));
    assertFalse(IntStream.of(1, 10).boxed().spliterator().hasCharacteristics(Spliterator.DISTINCT));
    ...
    assertTrue(
        IntStream.range(1, 10)
            ...
            .hasCharacteristics(Spliterator.SORTED | Spliterator.DISTINCT));
    assertFalse(
        IntStream.of(1, 10).asLongStream().spliterator().hasCharacteristics(Spliterator.SORTED));
    assertFalse(
        IntStream.of(1, 10).asLongStream().spliterator().hasCharacteristics(Spliterator.DISTINCT));
    ...
    assertTrue(
        IntStream.range(1, 10)
            ...
            .hasCharacteristics(Spliterator.SORTED | Spliterator.DISTINCT));
    assertFalse(
        IntStream.of(1, 10).asDoubleStream().spliterator().hasCharacteristics(Spliterator.SORTED));
    assertFalse(
        IntStream.of(1, 10)
            .asDoubleStream()
            .spliterator()
  ...
  public void testSortDistinct() {
...

    {
      ...
      assertEquals(
          IntStream.of(input).sorted().asLongStream().sorted().distinct().toArray(), expectedLongs);
