...
public class LongPrimitiveOpsTests {
  ...
  public void testFlags() {
    ...
    assertFalse(LongStream.of(1, 10).boxed().spliterator().hasCharacteristics(Spliterator.SORTED));
    assertFalse(
        LongStream.of(1, 10).boxed().spliterator().hasCharacteristics(Spliterator.DISTINCT));
    ...
    assertFalse(
        LongStream.of(1, 10).asDoubleStream().spliterator().hasCharacteristics(Spliterator.SORTED));
  }
  ...
  public void testSortDistinct() {
...

    {
      ...
      assertEquals(
          LongStream.of(input).sorted().distinct().asDoubleStream().sorted().distinct().toArray(),
          expectedDoubles);
    }
  }
