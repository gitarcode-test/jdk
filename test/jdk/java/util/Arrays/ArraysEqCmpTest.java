...
public class ArraysEqCmpTest {
  ...
  abstract static class ArrayType<T> {
    ...
    public ArrayType(Class<T> arrayType, boolean unsigned) {
      ...
      try {
        ...
        if (componentType.isPrimitive()) {
          ...
          MethodType eqt = MethodType.methodType(boolean.class, arrayType, arrayType);
          MethodType eqrt =
          ...
          cmp = l.findStatic(Arrays.class, compareName, eqt.changeReturnType(int.class));
          cmpr = l.findStatic(Arrays.class, compareName, eqrt.changeReturnType(int.class));

          mm = l.findStatic(Arrays.class, "mismatch", eqt.changeReturnType(int.class));
          mmr = l.findStatic(Arrays.class, "mismatch", eqrt.changeReturnType(int.class));

          toString =
              l.findStatic(
                  Arrays.class, "toString", MethodType.methodType(String.class, arrayType));
        } else {
          cpy =
              l.findStatic(
                  Arrays.class,
          ...
          MethodType eqt = MethodType.methodType(boolean.class, Object[].class, Object[].class);
          MethodType eqrt =
              MethodType.methodType(
                  boolean.class,
                  Object[].class,
          ...
          MethodType cmpt =
              MethodType.methodType(int.class, Comparable[].class, Comparable[].class);
          MethodType cmprt =
              MethodType.methodType(
                  int.class,
                  Comparable[].class,
          ...
          toString =
              l.findStatic(
                  Arrays.class, "toString", MethodType.methodType(String.class, Object[].class));
        }
    ...
    int compare(Object a, int aFromIndex, int aToIndex, Object b, int bFromIndex, int bToIndex) {
      try {
    ...
    static class BoxedIntegersWithReverseComparator extends BoxedIntegers {
      ...
      public BoxedIntegersWithReverseComparator() {
        try {
          ...
          MethodType cmpt =
              MethodType.methodType(int.class, Object[].class, Object[].class, Comparator.class);
          MethodType cmprt =
              MethodType.methodType(
                  int.class,
                  Object[].class,
  ...
  public void testArray(ArrayType<?> arrayType) {
    ...
    BiFunction<ArrayType<?>, Object, Object> cloner =
        (at, a) -> constructor.apply(at, Array.getLength(a));
  ...
  public void testPrimitiveFloatArray(
      ArrayType<?> arrayType,
      long canonicalNanRawBits,
      long nonCanonicalNanRawBits,
    ...
    BiFunction<ArrayType<?>, Object, Object> nonCanonicalNaNs =
        (at, a) -> {
    ...
    BiFunction<ArrayType<?>, Object, Object> halfNonCanonicalNaNs =
        (at, a) -> {
          int s = Array.getLength(a);
          Object ac = at.construct(s);
          for (int x = 0; x < s / 2; x++) {
    ...
    for (String[] o1 : values) {
      for (String[] o2 : values) {
        for (Comparator o3 : cs) {
          if (o1 != null && o2 != null && o3 != null) continue;
    ...
    for (int s : Arrays.asList(0, 1)) {
      ...
      for (int aFrom : froms) {
        for (int aTo : tos) {
          for (int bFrom : froms) {
            for (int bTo : tos) {
              if (aFrom >= 0 && aTo <= s && bFrom >= 0 && bTo <= s) continue;
