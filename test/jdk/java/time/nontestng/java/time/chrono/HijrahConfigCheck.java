...
public class HijrahConfigCheck {
  ...
  public static void main(String... args) {
    ...
    if (!c1.equals(c2)) {
      throw new RuntimeException(CALTYPE + " chronologies differ. c1: " + c1 + ", c2: " + c2);
    }
    ...
    if (!iso.toInstant(ZoneOffset.UTC).equals(hijrah.toInstant(ZoneOffset.UTC))) {
      throw new RuntimeException(
          "test Hijrah date is incorrect. LocalDate: " + iso + ", test date: " + hijrah);
    }
  }
}
