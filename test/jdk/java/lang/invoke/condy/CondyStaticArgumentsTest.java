...
public class CondyStaticArgumentsTest {
    ...
    MethodHandle mh =
        InstructionHelper.ldcDynamicConstant(
            ...
            MethodHandleDesc.ofMethod(
                ...
                mhi.getName(),
                MethodTypeDesc.ofDescriptor(mhi.getMethodType().descriptorString())));

    Assert.assertEquals(
        mh.invoke(),
        "constant-name-String-1-2-3.0-4.0-Number-something-(int,long,float,double)void-11");
  }
  ...
  static BigDecimal bigDecimal(
      MethodHandles.Lookup l, String name, Class<?> type, String value, MathContext mc) {
    return new BigDecimal(value, mc);
  }

  static String condyWithCondy(MethodHandles.Lookup l, String name, Class<?> type, BigDecimal d) {
    return new StringJoiner("-")
        .add(name)
        .add(type.getSimpleName())
        .add(d.toString())
  ...
  static ConstantCallSite indyWithCondy(
      MethodHandles.Lookup l, String name, MethodType type, BigDecimal d) {
    String s =
        new StringJoiner("-")
            .add(name)
  ...
  public void testIndyWithCondy() throws Throwable {
    ...
    MethodHandle mh =
        InstructionHelper.invokedynamic(
            L,
            "big-decimal-math-context",
