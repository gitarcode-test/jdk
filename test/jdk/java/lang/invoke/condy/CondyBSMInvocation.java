...
public class CondyBSMInvocation {
  ...
  public void testNonexistent() throws Throwable {
    MethodHandle mh =
        InstructionHelper.ldcDynamicConstant(
            L, "name", Object.class, "bsm", methodType(Object.class));
  ...
  public void testWrongShape() throws Throwable {
    for (MethodHandle bsm : bsms("shape_bsm")) {
      MethodHandle mh =
          InstructionHelper.ldcDynamicConstant(L, "name", Object.class, "shape_bsm", bsm.type());
  ...
  public void testWrongSignature() throws Throwable {
    for (MethodHandle bsm : bsms("sig_bsm")) {
      MethodHandle mh =
          InstructionHelper.ldcDynamicConstant(L, "name", Object.class, "sig_bsm", bsm.type());
  ...
  public static Object bsm(MethodHandles.Lookup l, String name, Class<?> type, Object a1) {
    assertAll(a1);
    return "1";
  }

  public static Object bsm(
      MethodHandles.Lookup l, String name, Class<?> type, Object a1, Object a2) {
    assertAll(a1, a2);
    return "2";
  }

  public static Object bsm(
      MethodHandles.Lookup l, String name, Class<?> type, Object a1, Object a2, Object a3) {
    assertAll(a1, a2, a3);
    return "3";
  }
  ...
  public void testArity() throws Throwable {
    for (int i = 0; i < 8; i++) {
      final int n = i;
      MethodType mt =
          methodType(Object.class, MethodHandles.Lookup.class, String.class, Class.class)
