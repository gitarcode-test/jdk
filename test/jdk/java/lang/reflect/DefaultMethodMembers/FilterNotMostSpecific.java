...
public class FilterNotMostSpecific {
    ...
    for (MethodDesc expected : expectedMethods) {
      if (expected.isGetMethodReturn()) {
        try {
          ...
          if (!assertMatch(expected, m)) fail(failMsg(expected, m, iface));
          else match = true;
  ...
  public void testGetMethods(Class<?> iface) {
    ...
    assertEquals(
        ...
        "\non: "
            + iface
            + "\nexpected: "
            + toMethodStrings(expectedMethods)
            + "\nfound: "
            + foundMethods
            + "\n");
  }
  ...
  private boolean assertMatch(MethodDesc expected, Method m) {
    if (!expected.name().equals(m.getName())) return false;
    if (expected.declaringClass() != m.getDeclaringClass()) return false;
    if (!Arrays.equals(expected.parameterTypes(), m.getParameterTypes())) return false;
    if (expected.returnType() != NotSpecified.class && expected.returnType() != m.getReturnType())
      return false;
  ...
  private String toMethodString(MethodDesc m) {
    return (m.returnType() != NotSpecified.class ? m.returnType().getSimpleName() + " " : "")
        + m.declaringClass().getSimpleName().toString()
        + "."
        + m.name()
        + Stream.of(m.parameterTypes())
            .map(cl -> cl.getSimpleName())
            .collect(Collectors.joining(", ", "(", ")"));
  }

  private List<String> toMethodStrings(MethodDesc[] m) {
    return Arrays.stream(m).map(this::toMethodString).collect(Collectors.toList());
  }
  ...
  interface Jbis extends Jprim {
    void nonDefault();
  }

  // interesting cases

  @MethodDesc(name = "nonDefault", declaringClass = Jbis.class, isGetMethodReturn = true)
  ...
  @MethodDesc(name = "nonDefault", declaringClass = J.class, isGetMethodReturn = true)
  ...
  @MethodDesc(name = "nonDefault", declaringClass = K1M.class, isGetMethodReturn = true)
  interface K1M extends J {
    void nonDefault();
  }
  ...
  @MethodDesc(name = "nonDefault", declaringClass = K2M.class, isGetMethodReturn = true)
  interface K2M extends J, I {
    void nonDefault();
  }
  ...
  @MethodDesc(name = "nonDefault", declaringClass = M.class, isGetMethodReturn = true)
  @MethodDesc(
      name = "isDefault",
  ...
  @MethodDesc(
      name = "isDefault",
      declaringClass = N1D.class,
      kind = MethodKind.DEFAULT,
      isGetMethodReturn = true)
  @MethodDesc(name = "nonDefault", declaringClass = M.class, isGetMethodReturn = true)
  interface N1D extends M {
    default void isDefault() {}
  }

  @MethodDesc(name = "nonDefault", declaringClass = N1N.class, isGetMethodReturn = true)
  @MethodDesc(
      name = "isDefault",
      declaringClass = M.class,
      kind = MethodKind.DEFAULT,
      isGetMethodReturn = true)
  interface N1N extends M {
    void nonDefault();
  }

  @MethodDesc(
      name = "isDefault",
      declaringClass = N1DN.class,
      kind = MethodKind.DEFAULT,
      isGetMethodReturn = true)
  @MethodDesc(name = "nonDefault", declaringClass = N1DN.class, isGetMethodReturn = true)
  interface N1DN extends M {
    default void isDefault() {}
  ...
  @MethodDesc(
      name = "isDefault",
      declaringClass = N2D.class,
      kind = MethodKind.DEFAULT,
      isGetMethodReturn = true)
  @MethodDesc(name = "nonDefault", declaringClass = M.class, isGetMethodReturn = true)
  interface N2D extends M, L {
    default void isDefault() {}
  }
  ...
  @MethodDesc(
      ...
      kind = MethodKind.DEFAULT,
      isGetMethodReturn = true)
  @MethodDesc(name = "nonDefault", declaringClass = N2N.class, isGetMethodReturn = true)
  interface N2N extends M, L {
    void nonDefault();
  }

  @MethodDesc(
      name = "isDefault",
      declaringClass = N2DN.class,
      kind = MethodKind.DEFAULT,
      isGetMethodReturn = true)
  @MethodDesc(name = "nonDefault", declaringClass = N2DN.class, isGetMethodReturn = true)
  interface N2DN extends M, L {
    default void isDefault() {}
  ...
  @MethodDesc(
      name = "nonDefault",
      declaringClass = C4.class,
      kind = MethodKind.CONCRETE,
      isGetMethodReturn = true)
  class C4 implements L, M, N2DN {
  ...
  @MethodDesc(
      name = "nonDefault",
      declaringClass = C5.class,
      kind = MethodKind.CONCRETE,
      isGetMethodReturn = true)
  class C5 implements M, N2DN, L {
    public void nonDefault() {}
  }
  ...
  @MethodDesc(
      name = "nonDefault",
      declaringClass = C6.class,
      kind = MethodKind.CONCRETE,
      isGetMethodReturn = true)
  class C6 implements N2DN, L, M {
    public void nonDefault() {}
  }

  // reabstraction

  @MethodDesc(name = "isDefault", declaringClass = R1.class, isGetMethodReturn = true)
  @MethodDesc(name = "nonDefault", declaringClass = N2DN.class, isGetMethodReturn = true)
  interface R1 extends L, M, N2DN {
    void isDefault();
  }

  @MethodDesc(name = "isDefault", declaringClass = R2.class, isGetMethodReturn = true)
  @MethodDesc(name = "nonDefault", declaringClass = N2DN.class, isGetMethodReturn = true)
  interface R2 extends M, N2DN, L {
    void isDefault();
  }

  @MethodDesc(name = "isDefault", declaringClass = R3.class, isGetMethodReturn = true)
  @MethodDesc(name = "nonDefault", declaringClass = N2DN.class, isGetMethodReturn = true)
  interface R3 extends N2DN, L, M {
    void isDefault();
  }
  ...
  interface Z3 extends Z2, Z1 {
    void z();
  }

  @MethodDesc(name = "z", declaringClass = Z3.class, isGetMethodReturn = true)
  ...
  @MethodDesc(name = "x", declaringClass = X2.class, isGetMethodReturn = true)
  ...
  @MethodDesc(
      name = "x",
      declaringClass = X3.class,
      kind = MethodKind.DEFAULT,
      isGetMethodReturn = true)
  interface X3 extends X2, X1 {
    default void x() {}
  }
  ...
  @MethodDesc(name = "nonDefault", declaringClass = K.class, isGetMethodReturn = true)
  ...
  interface B2A extends B1 {
    Map m();
  }

  interface B2B extends B1 {
    HashMap m();
  }
  ...
  @MethodDesc(
      name = "m",
      returnType = Object.class,
      declaringClass = B2A.class,
      kind = MethodKind.DEFAULT)
  @MethodDesc(
      name = "m",
      returnType = Object.class,
      declaringClass = B2B.class,
      kind = MethodKind.DEFAULT)
