 ...
 * @summary JDK implementation specific unit test for LoggerFinderLoader. Tests the behavior of
 *     LoggerFinderLoader with respect to the value of the internal diagnosability switches. Also
 *     test the DefaultLoggerFinder and SimpleConsoleLogger implementation.
 * @modules java.base/sun.util.logging java.base/jdk.internal.logger
 * @build AccessSystemLogger LoggerFinderLoaderTest CustomSystemClassLoader BaseLoggerFinder
 *     BaseLoggerFinder2
 * @run driver AccessSystemLogger
 * @run main/othervm -Xbootclasspath/a:boot -Djava.system.class.loader=CustomSystemClassLoader
 *     LoggerFinderLoaderTest NOSECURITY
 * @run main/othervm -Xbootclasspath/a:boot -Djava.security.manager=allow
 *     -Djava.system.class.loader=CustomSystemClassLoader LoggerFinderLoaderTest NOPERMISSIONS
 * @run main/othervm -Xbootclasspath/a:boot -Djava.security.manager=allow
 *     -Djava.system.class.loader=CustomSystemClassLoader LoggerFinderLoaderTest WITHPERMISSIONS
 * @run main/othervm -Xbootclasspath/a:boot -Djava.system.class.loader=CustomSystemClassLoader
 *     -Dtest.fails=true LoggerFinderLoaderTest NOSECURITY
 * @run main/othervm -Xbootclasspath/a:boot -Djava.security.manager=allow
 ...
 *     WITHPERMISSIONS
 * @run main/othervm -Xbootclasspath/a:boot -Djava.system.class.loader=CustomSystemClassLoader
 *     -Dtest.fails=true -Djdk.logger.finder.error=ERROR LoggerFinderLoaderTest NOSECURITY
 * @run main/othervm -Xbootclasspath/a:boot -Djava.security.manager=allow
 *     -Djava.system.class.loader=CustomSystemClassLoader -Dtest.fails=true
 *     -Djdk.logger.finder.error=ERROR LoggerFinderLoaderTest NOPERMISSIONS
 * @run main/othervm -Xbootclasspath/a:boot -Djava.security.manager=allow
 *     -Djava.system.class.loader=CustomSystemClassLoader -Dtest.fails=true
 *     -Djdk.logger.finder.error=ERROR LoggerFinderLoaderTest WITHPERMISSIONS
 * @run main/othervm -Xbootclasspath/a:boot -Djava.system.class.loader=CustomSystemClassLoader
 *     -Dtest.fails=true -Djdk.logger.finder.error=DEBUG LoggerFinderLoaderTest NOSECURITY
 * @run main/othervm -Xbootclasspath/a:boot -Djava.security.manager=allow
 *     -Djava.system.class.loader=CustomSystemClassLoader -Dtest.fails=true
 *     -Djdk.logger.finder.error=DEBUG LoggerFinderLoaderTest NOPERMISSIONS
 * @run main/othervm -Xbootclasspath/a:boot -Djava.security.manager=allow
 *     -Djava.system.class.loader=CustomSystemClassLoader -Dtest.fails=true
 *     -Djdk.logger.finder.error=DEBUG LoggerFinderLoaderTest WITHPERMISSIONS
 * @run main/othervm -Xbootclasspath/a:boot -Djava.system.class.loader=CustomSystemClassLoader
 *     -Dtest.fails=true -Djdk.logger.finder.error=QUIET LoggerFinderLoaderTest NOSECURITY
 * @run main/othervm -Xbootclasspath/a:boot -Djava.security.manager=allow
 *     -Djava.system.class.loader=CustomSystemClassLoader -Dtest.fails=true
 *     -Djdk.logger.finder.error=QUIET LoggerFinderLoaderTest NOPERMISSIONS
 * @run main/othervm -Xbootclasspath/a:boot -Djava.security.manager=allow
 *     -Djava.system.class.loader=CustomSystemClassLoader -Dtest.fails=true
 *     -Djdk.logger.finder.error=QUIET LoggerFinderLoaderTest WITHPERMISSIONS
 * @run main/othervm -Xbootclasspath/a:boot -Djava.system.class.loader=CustomSystemClassLoader
 *     -Djdk.logger.finder.singleton=true LoggerFinderLoaderTest NOSECURITY
 * @run main/othervm -Xbootclasspath/a:boot -Djava.security.manager=allow
 *     -Djava.system.class.loader=CustomSystemClassLoader -Djdk.logger.finder.singleton=true
 *     LoggerFinderLoaderTest NOPERMISSIONS
 * @run main/othervm -Xbootclasspath/a:boot -Djava.security.manager=allow
 *     -Djava.system.class.loader=CustomSystemClassLoader -Djdk.logger.finder.singleton=true
 *     LoggerFinderLoaderTest WITHPERMISSIONS
 * @run main/othervm -Xbootclasspath/a:boot -Djava.system.class.loader=CustomSystemClassLoader
 *     -Djdk.logger.finder.singleton=true -Djdk.logger.finder.error=ERROR LoggerFinderLoaderTest
 *     NOSECURITY
 * @run main/othervm -Xbootclasspath/a:boot -Djava.security.manager=allow
 *     -Djava.system.class.loader=CustomSystemClassLoader -Djdk.logger.finder.singleton=true
 *     -Djdk.logger.finder.error=ERROR LoggerFinderLoaderTest NOPERMISSIONS
 ...
 *     -Djdk.logger.finder.error=ERROR LoggerFinderLoaderTest WITHPERMISSIONS
 * @run main/othervm -Xbootclasspath/a:boot -Djava.system.class.loader=CustomSystemClassLoader
 *     -Djdk.logger.finder.singleton=true -Djdk.logger.finder.error=DEBUG LoggerFinderLoaderTest
 *     NOSECURITY
 * @run main/othervm -Xbootclasspath/a:boot -Djava.security.manager=allow
 *     -Djava.system.class.loader=CustomSystemClassLoader -Djdk.logger.finder.singleton=true
 *     -Djdk.logger.finder.error=DEBUG LoggerFinderLoaderTest NOPERMISSIONS
 ...
 *     -Djdk.logger.finder.error=DEBUG LoggerFinderLoaderTest WITHPERMISSIONS
 * @run main/othervm -Xbootclasspath/a:boot -Djava.system.class.loader=CustomSystemClassLoader
 *     -Djdk.logger.finder.singleton=true -Djdk.logger.finder.error=QUIET LoggerFinderLoaderTest
 *     NOSECURITY
 * @run main/othervm -Xbootclasspath/a:boot -Djava.security.manager=allow
 *     -Djava.system.class.loader=CustomSystemClassLoader -Djdk.logger.finder.singleton=true
 *     -Djdk.logger.finder.error=QUIET LoggerFinderLoaderTest NOPERMISSIONS
...
public class LoggerFinderLoaderTest {
  ...
  static final ThreadLocal<AtomicBoolean> allowControl =
  ...
  static final ThreadLocal<AtomicBoolean> allowAccess =
      new ThreadLocal<AtomicBoolean>() {
        @Override
        protected AtomicBoolean initialValue() {
          return new AtomicBoolean(false);
  ...
  public static interface TestLoggerFinder {
    public static final AtomicBoolean fails = new AtomicBoolean();
    public static final AtomicReference<String> conf = new AtomicReference<>("");
  ...
  static LoggerFinder getLoggerFinder(
      Class<?> expectedClass, String errorPolicy, boolean singleton) {
        ...
        if ("ERROR".equals(errorPolicy.toUpperCase(Locale.ROOT))) {
          ...
          if (!warning.contains(
            ...
            throw new RuntimeException(
                "Expected message not found. Error stream contained: " + warning);
          }
          ...
          if (TestLoggerFinder.fails.get()) {
            if (!warning.contains(
                "java.util.ServiceConfigurationError: java.lang.System$LoggerFinder: Provider"
                    + " BaseLoggerFinder could not be instantiated")) {
              throw new RuntimeException(
                  "Expected message not found. Error stream contained: " + warning);
            }
          } else if (singleton) {
            if (!warning.contains(
                "java.util.ServiceConfigurationError: More than one LoggerFinder implementation")) {
              throw new RuntimeException(
                  "Expected message not found. Error stream contained: " + warning);
            }
          }
          ...
          if (!warning.isEmpty()) {
            throw new RuntimeException(
                "Unexpected error message found: " + ErrorStream.errorStream.peek());
          }
        }
      }
  ...
  public static void main(String[] args) {
    if (args.length == 0) {
      args = new String[] {"NOSECURITY", "NOPERMISSIONS", "WITHPERMISSIONS"};
    }
  ...
  private static void testLogger(
    ...
    for (Level loggerLevel : EnumSet.of(Level.INFO)) {
      for (Level messageLevel : Level.values()) {
        ...
        String desc =
            "logger.log(messageLevel, foo): loggerLevel="
                + loggerLevel
                + ", messageLevel="
                + messageLevel;
        ...
        if (loggerLevel == Level.OFF
          ...
          if (!logged.contains("LoggerFinderLoaderTest testLogger")
            ...
            verbose("Got expected results for " + desc + "\n<<<<\n" + logged + ">>>>\n");
          }
        }
      }
    }
    ...
    for (Level loggerLevel : EnumSet.of(Level.INFO)) {
      for (Level messageLevel : Level.values()) {
        String desc =
            "logger.log(messageLevel, \"blah\"): loggerLevel="
                + loggerLevel
                + ", messageLevel="
                + messageLevel;
        sequencer.incrementAndGet();
    ...
    for (Level loggerLevel : EnumSet.of(Level.INFO)) {
      for (Level messageLevel : Level.values()) {
        String desc =
            "logger.log(messageLevel, fooSupplier): loggerLevel="
                + loggerLevel
                + ", messageLevel="
                + messageLevel;
        sequencer.incrementAndGet();
    ...
    for (Level loggerLevel : EnumSet.of(Level.INFO)) {
      for (Level messageLevel : Level.values()) {
        String desc =
            "logger.log(messageLevel, format, params...): loggerLevel="
                + loggerLevel
                + ", messageLevel="
                + messageLevel;
        sequencer.incrementAndGet();
    ...
    for (Level loggerLevel : EnumSet.of(Level.INFO)) {
      for (Level messageLevel : Level.values()) {
        String desc =
            "logger.log(messageLevel, \"blah\", thrown): loggerLevel="
                + loggerLevel
                + ", messageLevel="
                + messageLevel;
        sequencer.incrementAndGet();
    ...
    for (Level loggerLevel : EnumSet.of(Level.INFO)) {
      for (Level messageLevel : Level.values()) {
        String desc =
            "logger.log(messageLevel, thrown, fooSupplier): loggerLevel="
                + loggerLevel
                + ", messageLevel="
                + messageLevel;
        sequencer.incrementAndGet();
    ...
    for (Level loggerLevel : EnumSet.of(Level.INFO)) {
      for (Level messageLevel : Level.values()) {
        String desc =
            "logger.log(messageLevel, bundle, format, params...): loggerLevel="
                + loggerLevel
                + ", messageLevel="
                + messageLevel;
        sequencer.incrementAndGet();
    ...
    for (Level loggerLevel : EnumSet.of(Level.INFO)) {
      for (Level messageLevel : Level.values()) {
        String desc =
            "logger.log(messageLevel, bundle, \"blah\", thrown): loggerLevel="
                + loggerLevel
                + ", messageLevel="
                + messageLevel;
        sequencer.incrementAndGet();
  ...
  public static class SimplePolicy extends Policy {
    static final RuntimePermission CONTROL = LOGGERFINDER_PERMISSION;
    static final RuntimePermission ACCESS =
        new RuntimePermission("accessClassInPackage.jdk.internal.logger");
    ...
    public SimplePolicy(
        ThreadLocal<AtomicBoolean> allowControl, ThreadLocal<AtomicBoolean> allowAccess) {
    ...
    Permissions getPermissions() {
      if (allowControl.get().get() || allowAccess.get().get()) {
        PermissionsBuilder builder = new PermissionsBuilder().addAll(permissions);
