...
public class PropertyTest {
  ...
  static void replaceSetProperties() {
    ...
    Assert.assertSame(
        System.getProperties(), newProps, "getProperties not the same as setProperties");
  ...
  public static void main(String[] args) {
    ...
    tla.getPassedTests().stream()
        .forEach(t -> System.out.printf("Passed: %s%s%n", t.getName(), List.of(t.getParameters())));
    tla.getFailedTests().stream()
        .forEach(t -> System.out.printf("Failed: %s%s%n", t.getName(), List.of(t.getParameters())));
  }
}
