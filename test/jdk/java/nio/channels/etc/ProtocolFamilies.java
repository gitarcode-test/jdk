...
public class ProtocolFamilies {
  ...
  public void scOpen(StandardProtocolFamily family, Class<? extends Exception> expectedException)
      throws Throwable {
  ...
  @Test(dataProvider = "open")
  public void sscOpen(StandardProtocolFamily family, Class<? extends Exception> expectedException)
      throws Throwable {
  ...
  @Test(dataProvider = "open")
  public void dcOpen(StandardProtocolFamily family, Class<? extends Exception> expectedException)
      throws Throwable {
  ...
  public void scOpenBind(
      StandardProtocolFamily ofamily,
    ...
    try (SocketChannel sc = openSC(ofamily)) {
      ...
      if (expectedException == null) bindOp.run();
      else assertThrows(expectedException, bindOp);
    }
  }
  ...
  public void scOpenConnect(
      StandardProtocolFamily sfamily,
    ...
    try (ServerSocketChannel ssc = openSSC(sfamily)) {
      ...
      try (SocketChannel sc = openSC(cfamily)) {
        if (expectedException == null) sc.connect(saddr);
        else assertThrows(expectedException, () -> sc.connect(saddr));
      }
    }
  }
  ...
  private static SocketChannel openSC(StandardProtocolFamily family) throws IOException {
    SocketChannel sc = family == null ? SocketChannel.open() : SocketChannel.open(family);
    return sc;
  }

  private static ServerSocketChannel openSSC(StandardProtocolFamily family) throws IOException {
    ServerSocketChannel ssc =
        family == null ? ServerSocketChannel.open() : ServerSocketChannel.open(family);
    return ssc;
  }

  private static DatagramChannel openDC(StandardProtocolFamily family) throws IOException {
    DatagramChannel dc = family == null ? DatagramChannel.open() : DatagramChannel.open(family);
    return dc;
  }
  ...
  private static Inet4Address getLocalIPv4Address() throws Exception {
  ...
  private static Inet6Address getLocalIPv6Address() throws Exception {
