...
public class Disconnect {
  ...
  /**
   * Connect DatagramChannel to a server, write a datagram and disconnect. Invoke a second or
   * subsequent time with the same DatagramChannel instance to check that disconnect works as
   * expected.
   */
