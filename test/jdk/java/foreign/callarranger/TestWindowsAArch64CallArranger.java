...
public class TestWindowsAArch64CallArranger extends CallArrangerTestBase {
  ...
  public void testWindowsArgsInRegs() {
    MethodType mt =
        MethodType.methodType(void.class, int.class, int.class, float.class, double.class);
  ...
  public void testWindowsVarArgsInRegs() {
    ...
    FunctionDescriptor fdExpected =
        FunctionDescriptor.ofVoid(ADDRESS, C_INT, C_INT, C_FLOAT, C_DOUBLE);
    CallArranger.Bindings bindings =
        CallArranger.WINDOWS.getBindings(
  ...
  public void testWindowsArgsInRegsAndOnStack() {
    ...
    FunctionDescriptor fd =
        FunctionDescriptor.ofVoid(
            C_DOUBLE, C_INT, C_FLOAT, C_DOUBLE, C_FLOAT, C_FLOAT, C_DOUBLE, C_FLOAT, C_FLOAT,
            C_FLOAT, C_INT);
    CallArranger.Bindings bindings = CallArranger.WINDOWS.getBindings(mt, fd, false);
  ...
  public void testWindowsVarArgsInRegsAndOnStack() {
    ...
    FunctionDescriptor fdExpected =
        FunctionDescriptor.ofVoid(
            ADDRESS, C_DOUBLE, C_INT, C_FLOAT, C_DOUBLE, C_FLOAT, C_FLOAT, C_DOUBLE, C_FLOAT,
            C_FLOAT, C_FLOAT);
    CallArranger.Bindings bindings =
        CallArranger.WINDOWS.getBindings(
            mt, fd, false, LinkerOptions.forDowncall(fd, firstVariadicArg(1)));
  ...
  public void testWindowsVariadicHfa4FloatsInIntRegs() {
    ...
    CallArranger.Bindings bindings =
        CallArranger.WINDOWS.getBindings(
            mt, fd, false, LinkerOptions.forDowncall(fd, firstVariadicArg(0)));
