...
public class TestMacOsAArch64CallArranger extends CallArrangerTestBase {
  ...
  public void testVarArgsOnStack() {
    ...
    CallArranger.Bindings bindings =
        CallArranger.MACOS.getBindings(
  ...
  public void testMacArgsOnStack() {
    ...
    FunctionDescriptor fd =
        FunctionDescriptor.ofVoid(
            C_INT, C_INT, C_INT, C_INT, C_INT, C_INT, C_INT, C_INT, C_INT, C_INT, C_SHORT, C_CHAR);
  ...
  public void testMacArgsOnStack2() {
    StructLayout struct = MemoryLayout.structLayout(C_FLOAT, C_FLOAT);
    MethodType mt =
        MethodType.methodType(
            void.class,
            long.class,
  ...
  public void testMacArgsOnStack3() {
    StructLayout struct = MemoryLayout.structLayout(C_POINTER, C_POINTER);
    MethodType mt =
        MethodType.methodType(
            void.class,
            long.class,
    ...
    checkArgumentBindings(
        ...
        new Binding[][] {
          ...
          {vmStore(v7, double.class)},
          {
            ...
            vmStore(stackStorage((short) 8, 8), long.class)
          },
  ...
  public void testMacArgsOnStack4() {
    StructLayout struct = MemoryLayout.structLayout(C_INT, C_INT, C_POINTER);
    MethodType mt =
        MethodType.methodType(
            void.class,
            long.class,
    ...
    checkArgumentBindings(
        ...
        new Binding[][] {
          ...
          {vmStore(stackStorage((short) 4, 0), float.class)},
          {
            ...
            vmStore(stackStorage((short) 8, 8), long.class),
            bufferLoad(8, long.class),
            vmStore(stackStorage((short) 8, 16), long.class)
          },
        });
  ...
  public void testMacArgsOnStack5() {
    StructLayout struct = MemoryLayout.structLayout(C_FLOAT);
    MethodType mt =
        MethodType.methodType(
            void.class,
            long.class,
    ...
    checkArgumentBindings(
        ...
        new Binding[][] {
          ...
          {vmStore(v7, double.class)},
          {
            bufferLoad(0, int.class), vmStore(stackStorage((short) 4, 0), int.class),
          },
          {vmStore(stackStorage((short) 4, 4), int.class)},
  ...
  public void testMacArgsOnStack6() {
    StructLayout struct = MemoryLayout.structLayout(C_INT);
    MethodType mt =
        MethodType.methodType(
            void.class,
            long.class,
    ...
    checkArgumentBindings(
        ...
        new Binding[][] {
          ...
          {vmStore(stackStorage((short) 4, 0), int.class)},
          {
            bufferLoad(0, int.class), vmStore(stackStorage((short) 4, 8), int.class),
          },
