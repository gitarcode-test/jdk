...
public class TestLinuxAArch64CallArranger extends CallArrangerTestBase {
  ...
  public static Object[][] structs() {
    ...
    return new Object[][] {
      ...
      {struct2, new Binding[] {copy(struct2), unboxAddress(), vmStore(r0, long.class)}},
      // struct s { int32_t a[2]; float b[2] };
      {
        MemoryLayout.structLayout(C_INT, C_INT, C_FLOAT, C_FLOAT),
        new Binding[] {
          dup(),
          // s.a[0] & s.a[1]
          bufferLoad(0, long.class),
  ...
  public void testMultipleStructs() {
    ...
    checkArgumentBindings(
        ...
        new Binding[][] {
          {unboxAddress(), vmStore(TARGET_ADDRESS_STORAGE, long.class)},
          {copy(struct1), unboxAddress(), vmStore(r0, long.class)},
          {copy(struct2), unboxAddress(), vmStore(r1, long.class)},
          {vmStore(r2, int.class)}
        });
  ...
  public void testReturnStruct1() {
    ...
    checkArgumentBindings(
        ...
        new Binding[][] {
          {unboxAddress(), vmStore(TARGET_ADDRESS_STORAGE, long.class)},
          {unboxAddress(), vmStore(r8, long.class)}
        });
  ...
  public void testFloatArrayStruct() {
    ...
    StructLayout S10 = MemoryLayout.structLayout(MemoryLayout.sequenceLayout(4, C_DOUBLE));
    ...
    FunctionDescriptor fdExpected =
        FunctionDescriptor.of(S10, ADDRESS, ADDRESS, S10); // uses return buffer
    CallArranger.Bindings bindings = CallArranger.LINUX.getBindings(mt, fd, false);
