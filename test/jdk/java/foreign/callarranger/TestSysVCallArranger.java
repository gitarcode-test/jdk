...
public class TestSysVCallArranger extends CallArrangerTestBase {
  ...
  public void testNestedStructs() {
    MemoryLayout POINT = MemoryLayout.structLayout(C_INT, MemoryLayout.structLayout(C_INT, C_INT));
  ...
  public void testNestedUnion() {
    MemoryLayout POINT =
        MemoryLayout.structLayout(
            ...
            MemoryLayout.unionLayout(MemoryLayout.structLayout(C_INT, C_INT), C_LONG));
    MethodType mt = MethodType.methodType(void.class, MemorySegment.class);
    FunctionDescriptor fd = FunctionDescriptor.ofVoid(POINT);
    CallArranger.Bindings bindings = CallArranger.getBindings(mt, fd, false);
  ...
  public void testIntegerRegs() {
    MethodType mt =
        MethodType.methodType(
            void.class, int.class, int.class, int.class, int.class, int.class, int.class);
    FunctionDescriptor fd = FunctionDescriptor.ofVoid(C_INT, C_INT, C_INT, C_INT, C_INT, C_INT);
    CallArranger.Bindings bindings = CallArranger.getBindings(mt, fd, false);
  ...
  public void testMixed() {
    ...
    FunctionDescriptor fd =
        FunctionDescriptor.ofVoid(
            C_LONG, C_LONG, C_LONG, C_LONG, C_LONG, C_LONG, C_LONG, C_LONG, C_FLOAT, C_FLOAT,
   ...
   *
   * <p>struct structparm { int32_t a, int32_t b, double d; } s; int32_t e, f, g, h, i, j, k; double
   * m, n;
   *
   * <p>void m(e, f, s, g, h, m, n, i, j, k);
   *
   * <p>m(s);
   */
  @Test
  ...
  public static Object[][] structs() {
    return new Object[][] {
      {
        MemoryLayout.structLayout(C_LONG),
        new Binding[] {bufferLoad(0, long.class), vmStore(rdi, long.class)}
      },
      {
        MemoryLayout.structLayout(C_LONG, C_LONG),
        new Binding[] {
          dup(),
          bufferLoad(0, long.class),
          vmStore(rdi, long.class),
      ...
      {
        MemoryLayout.structLayout(C_LONG, C_LONG, C_LONG),
        new Binding[] {
          dup(),
          bufferLoad(0, long.class),
          vmStore(stackStorage(STACK_SLOT_SIZE, 0), long.class),
          ...
          bufferLoad(8, long.class),
          vmStore(stackStorage(STACK_SLOT_SIZE, 8), long.class),
          bufferLoad(16, long.class),
          vmStore(stackStorage(STACK_SLOT_SIZE, 16), long.class)
        }
      },
      {
        MemoryLayout.structLayout(C_LONG, C_LONG, C_LONG, C_LONG),
        new Binding[] {
          dup(),
          bufferLoad(0, long.class),
          vmStore(stackStorage(STACK_SLOT_SIZE, 0), long.class),
          ...
          bufferLoad(16, long.class),
          vmStore(stackStorage(STACK_SLOT_SIZE, 16), long.class),
          bufferLoad(24, long.class),
          vmStore(stackStorage(STACK_SLOT_SIZE, 24), long.class)
        }
      },
    };
  }
  ...
  public void testFloatStructsUpcall() {
    ...
    checkReturnBindings(
        callingSequence, new Binding[] {bufferLoad(0, float.class), vmStore(xmm0, float.class)});
