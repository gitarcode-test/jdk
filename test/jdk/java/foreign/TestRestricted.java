...
/**
 * This test checks all methods in java.base to make sure that methods annotated with {@link
 * Restricted} are expected restricted methods. Conversely, the test also checks that there is no
 * expected restricted method that is not marked with the annotation. For each restricted method, we
 * also check that they are marked with the {@link CallerSensitive} annotation.
 */
public class TestRestricted {
  ...
  static final Set<RestrictedMethod> RESTRICTED_METHODS =
      Set.of(
          RestrictedMethod.of(
              SymbolLookup.class, "libraryLookup", SymbolLookup.class, String.class, Arena.class),
          RestrictedMethod.of(
              SymbolLookup.class, "libraryLookup", SymbolLookup.class, Path.class, Arena.class),
          RestrictedMethod.of(
              Linker.class,
              "downcallHandle",
              MethodHandle.class,
          ...
          RestrictedMethod.of(
              MemorySegment.class, "reinterpret", MemorySegment.class, Arena.class, Consumer.class),
          RestrictedMethod.of(
              MemorySegment.class,
              "reinterpret",
              MemorySegment.class,
              ...
              Consumer.class),
          RestrictedMethod.of(
              AddressLayout.class, "withTargetLayout", AddressLayout.class, MemoryLayout.class),
          RestrictedMethod.of(
  ...
  public void testRestricted() {
    ...
    restrictedMethods(Object.class.getModule())
        .forEach(m -> checkRestrictedMethod(m, restrictedMethods));
  ...
  void checkRestrictedMethod(Method meth, Set<RestrictedMethod> restrictedMethods) {
    ...
    assertTrue(
        meth.isAnnotationPresent(CallerSensitive.class),
        "@CallerSensitive annotation not found on restricted method " + sig);
  }

  /**
   * Returns a stream of all restricted methods on public classes in packages exported by a named
   * module. This logic is borrowed from CallerSensitiveTest.
   */
  ...
  /** Returns a list of restricted methods directly declared by the given class. */
