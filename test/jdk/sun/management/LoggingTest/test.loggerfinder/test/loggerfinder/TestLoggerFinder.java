...
/**
 * A LoggerFinder that provides System.Logger which print directly on System.err, without involving
 * java.logging. For the purpose of the test, loggers whose name start with java.management. will
 * log all messages, and other loggers will only log level > INFO.
 *
 * @author danielfuchs
 */
