...
public abstract class Test {
  ...
  static final String CERTIFICATE_SELF_SIGNED = "The signer's certificate is self-signed.";
  ...
  static final String HAS_EXPIRED_CERT_SIGNING_WARNING = "The signer certificate has expired.";
  ...
  static final String WEAK_KEY_WARNING = "This key size will be disabled in a future update.";

  static final String JAR_SIGNED = "jar signed.";

  static final String JAR_VERIFIED = "jar verified.";

  static final String JAR_VERIFIED_WITH_SIGNER_ERRORS = "jar verified, with signer errors.";
  ...
  protected void createAlias(String alias, String... options) throws Throwable {
    ...
    keytool(cmd.toArray(new String[cmd.size()])).shouldHaveExitValue(0);
  }

  protected void issueCert(String alias, String... options) throws Throwable {
    keytool(
            "-certreq",
            "-alias",
            alias,
  ...
  protected void checkVerifying(OutputAnalyzer analyzer, int expectedExitCode, String... warnings) {
