...
public class SignUsingSHA2withRSA {
  ...
  private static final byte[] toBeSigned =
  ...
  public static void main(String[] args) throws Exception {
    ...
    ks.setKeyEntry(
        ...
        gen.getPrivateKey(),
        null,
        new Certificate[] {gen.getSelfCertificate(new X500Name("cn=localhost,c=US"), 100)});
  ...
  static void run() throws Exception {
    ...
    if (providers == null) {
      ...
      System.out.println(
          "The following JCE providers support the " + "'Signature.SHA256withRSA' algorithm: ");
  ...
  private static byte[] signUsing(String signAlgorithm, PrivateKey privateKey) throws Exception {
  ...
  private static void verifyUsing(String signAlgorithm, PublicKey publicKey, byte[] signature)
      throws Exception {
    ...
    System.out.println(
        String.format(
            "0x%0" + (signature.length * 2) + "x", new java.math.BigInteger(1, signature)));
