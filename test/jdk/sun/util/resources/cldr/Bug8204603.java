...
public class Bug8204603 {
  private static final Map<Locale, String> CALENDAR_DATA_MAP =
      Map.of(
          Locale.forLanguageTag("zh-CN"), "\u5468\u65E5",
          Locale.forLanguageTag("zh-TW"), "\u9031\u65E5");
  private static final Map<Locale, String> NAN_DATA_MAP =
      Map.of(
  ...
  private static void testCldrSupportedLocales() {
    ...
    Set<String> langtags =
        Arrays.stream(cldr.getAvailableLocales())
  ...
  private static void testCalendarData(Locale loc, String expected) {
    ...
    if (!actual.equals(expected)) {
      throw new RuntimeException(
          "Calendar data mismatch for locale: "
              + loc
              + ", expected  is: "
              + expected
              + ", actual is: "
