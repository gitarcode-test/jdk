...
public class ServerMimeTypesResolutionTest {
  ...
  private static Path createFileTreeFromMimeTypes(Properties properties) throws IOException {
    final Path root =
        Files.createDirectory(CWD.resolve(ServerMimeTypesResolutionTest.class.getSimpleName()));
  ...
  public static void testMimeTypeHeaders() throws Exception {
    final var server =
        SimpleFileServer.createFileServer(
            LOOPBACK_ADDR, root, SimpleFileServer.OutputLevel.VERBOSE);
    server.start();
    try {
      final var client = HttpClient.newBuilder().proxy(NO_PROXY).build();
      final Map<String, String> mimeTypesPerFileExtension =
          getMimeTypesPerFileExtension(SUPPORTED_MIME_TYPES);
      for (String extension : supportedFileExtensions) {
  ...
  private static void execute(
      HttpServer server, HttpClient client, String extension, String expectedMimeType)
  ...
  public static Object[][] commonExtensions() {
    Set<String> extensions =
        Set.of(
            ...
            ".csv", ".doc", ".docx", ".eot", ".epub", ".gz", ".gif", ".htm", ".html", ".ico",
            ".ics", ".jar", ".jpeg", ".jpg", ".js", ".json", ".jsonld", ".mid", ".midi", ".mjs",
            ".mp3", ".cda", ".mp4", ".mpeg", ".mpkg", ".odp", ".ods", ".odt", ".oga", ".ogv",
            ".ogx", ".opus", ".otf", ".png", ".pdf", ".php", ".ppt", ".pptx", ".rar", ".rtf", ".sh",
            ".svg", ".swf", ".tar", ".tif", ".tiff", ".ts", ".ttf", ".txt", ".vsd", ".wav", ".weba",
  ...
  /**
   * This is a one-off test to check which common file extensions are currently supported by the
   * system-wide mime table returned by {@linkplain java.net.FileNameMap#getContentTypeFor(String)
   * getContentTypeFor}.
   *
   * <p>Source common mime types:
