...
public class CommandLinePositiveTest {
  ...
  @DataProvider
  public Object[][] directoryOptions() {
    return new Object[][] {{"-d"}, {"--directory"}};
  }
  ...
  public void testDirectory(String opt) throws Throwable {
    ...
    simpleserver(JWEBSERVER, "-p", "0", opt, TEST_DIR_STR)
        ...
        .shouldContain(
            "Serving " + TEST_DIR_STR + " and subdirectories on " + LOOPBACK_ADDR + " port")
        .shouldContain("URL http://" + LOOPBACK_ADDR);
  }

  @DataProvider
  public Object[][] portOptions() {
    return new Object[][] {{"-p"}, {"--port"}};
  }
  ...
  @DataProvider
  public Object[][] helpOptions() {
    return new Object[][] {{"-h"}, {"-?"}, {"--help"}};
  }
  ...
  public void testVersion(String opt) throws Throwable {
    ...
    simpleserver(
            WaitForLine.VERSION_STARTUP_LINE,
            false, // do not explicitly destroy the process
            JWEBSERVER,
            opt)
        .shouldHaveExitValue(0);
  ...
  @DataProvider
  public Object[][] bindOptions() {
    return new Object[][] {{"-b"}, {"--bind-address"}};
  }
  ...
  public void testBindAllInterfaces(String opt) throws Throwable {
    ...
    simpleserver(JWEBSERVER, "-p", "0", opt, "0.0.0.0")
        .shouldHaveExitValue(NORMAL_EXIT_CODE)
        .shouldContain(
            "Serving " + TEST_DIR_STR + " and subdirectories on 0.0.0.0 (all interfaces) port")
  ...
  @DataProvider
  public Object[][] outputOptions() {
    return new Object[][] {{"-o"}, {"--output"}};
  }
  ...
  static String getJwebserver(Path image) {
    ...
    if (Files.notExists(jwebserver)) throw new RuntimeException(jwebserver + " not found");
  ...
  static OutputAnalyzer simpleserver(WaitForLine waitForLine, boolean destroy, String... args)
      throws Throwable {
