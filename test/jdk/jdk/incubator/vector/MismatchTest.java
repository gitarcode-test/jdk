    ...
    public ArrayType(Class<T> arrayType, boolean unsigned) {
      ...
      try {
        ...
        if (componentType.isPrimitive()) {
          ...
          cmp = l.findStatic(VectorArrays.class, compareName, eqt.changeReturnType(int.class));

          mm = l.findStatic(VectorArrays.class, "mismatch", eqt.changeReturnType(int.class));
