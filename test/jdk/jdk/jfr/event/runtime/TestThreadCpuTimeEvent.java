...
public class TestThreadCpuTimeEvent {
  ...
  // the requested period of time (in case the thread didn't get scheduled within the allotted
  // time).
  ...
  static List<RecordedEvent> generateEvents(int minimumEventCount, CyclicBarrier barrier)
      throws Throwable {
    int retryCount = 0;
