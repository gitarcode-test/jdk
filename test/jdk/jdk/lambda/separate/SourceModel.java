...
public class SourceModel {
  ...
  public abstract static class Type extends Element {
    private String name;
    ...
    public List<Extends> getSupertypes() {
    ...
    public abstract void generateAsDependency(SourceProcessor sp, Set<Method> neededMethods);
    ...
    protected void generateBody(PrintWriter pw, String superSpec) {
      StringJoiner joiner = new StringJoiner(",", superSpec + " ", " ").setEmptyValue("");
    ...
    protected void generateBodyAsDependency(PrintWriter pw, Set<Method> neededMethods) {
      pw.println(" {");
    ...
    public Collection<Type> typeDependencies() {
      ...
      for (Extends e : getSupertypes()) dependencies.put(e.getType().getName(), e.getType());
      // Do these last so that they override
      for (Type t : this.typeDependencies) dependencies.put(t.getName(), t);
  ...
  public static class Class extends Type {
    ...
    public void generateAsDependency(SourceProcessor processor, Set<Method> neededMethods) {
      StringWriter sw = new StringWriter();
      PrintWriter pw = new PrintWriter(sw);
      generateAccessFlags(pw);
      pw.print("class ");
  ...
  public abstract static class Method extends Element {
    private String name;
    ...
    public void suppressWarnings() {
      this.emitSuppressWarnings = true;
    }
  ...
  public static class AbstractMethod extends Method {
    public AbstractMethod(String ret, String name, Element... params) {
    ...
    public static AbstractMethod std() {
      return new AbstractMethod("int", SourceModel.stdMethodName, AccessFlag.PUBLIC);
    }
  }
  ...
  public static class ConcreteMethod extends Method {
    ...
    public ConcreteMethod(String ret, String name, String body, Element... params) {
      super(ret, name, params);
      this.body = body;
    }
    ...
    public static ConcreteMethod std(String value) {
      return new ConcreteMethod(
          "int", SourceModel.stdMethodName, "return " + value + ";", AccessFlag.PUBLIC);
    }
  }
  ...
  public static class DefaultMethod extends Method {
    ...
    public DefaultMethod(String ret, String name, String body, Element... params) {
      super(ret, name, params);
      this.body = body;
    ...
    public static DefaultMethod std(String value) {
      return new DefaultMethod("int", SourceModel.stdMethodName, "return " + value + ";");
    }
  }
}
