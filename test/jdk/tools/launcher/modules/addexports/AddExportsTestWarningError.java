 ...
 * @build jdk.test.lib.compiler.ModuleInfoMaker jdk.test.lib.compiler.CompilerUtils
...
public class AddExportsTestWarningError {
  ...
  public void setup() throws Exception {
    ...
    builder.writeJavaFiles(
        "m1",
        "module m1 { }",
        "package p1; public class C1 { " + "    public static void main(String... args) {}" + "}");
  ...
  public Object[][] missingArguments() {
    return new Object[][] {
      {new String[] {"--add-exports"}, "Error: --add-exports requires modules to be specified"},
      {new String[] {"--add-exports="}, "Error: --add-exports= requires modules to be specified"},
      {new String[] {"--add-exports", ""}, "Error: --add-exports requires modules to be specified"}
    };
  }
