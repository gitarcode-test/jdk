...
public class JImageExtractTest extends JImageCliTest {
  ...
  public void testExtractNoImageSpecified() {
    jimage("extract", "").assertFailure().assertShowsError();
  }
  ...
  public void testExtractNotAnImage() throws IOException {
    ...
    jimage("extract", tmp.toString()).assertFailure().assertShowsError();
  }
  ...
  public void testExtractToUnspecifiedDir() {
    jimage("extract", "--dir", "--", getImagePath()).assertFailure().assertShowsError();
  }
  ...
  public void testExtractFromDir() {
    ...
    jimage("extract", imageDirPath.toString()).assertFailure().assertShowsError();
  }
  ...
  public void testExtractToFile() throws IOException {
    ...
    jimage("extract", "--dir", tmp.toString(), getImagePath()).assertFailure().assertShowsError();
  }
  ...
  private void verifyExplodedImage(Path imagePath, Set<Path> notJImageModules) throws IOException {
    ...
    assertTrue(
        allModules.stream().anyMatch(p -> "java.base".equals(p.getFileName().toString())),
