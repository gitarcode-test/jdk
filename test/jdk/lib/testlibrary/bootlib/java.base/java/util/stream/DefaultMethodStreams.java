...
public final class DefaultMethodStreams {
  ...
  /**
   * Creates a stream that for the next operation either delegates to a default method on {@link
   * Stream}, if present for that operation, otherwise delegates to an underlying stream.
   *
   * @param s the underlying stream to be delegated to for non-default methods.
  ...
  /**
   * Creates a stream that for the next operation either delegates to a default method on {@link
   * IntStream}, if present for that operation, otherwise delegates to an underlying stream.
   *
   * @param s the underlying stream to be delegated to for non-default methods.
   * @return the delegating stream
   */
  ...
  /**
   * Creates a stream that for the next operation either delegates to a default method on {@link
   * LongStream}, if present for that operation, otherwise delegates to an underlying stream.
   *
   * @param s the underlying stream to be delegated to for non-default methods.
   * @return the delegating stream
   */
  ...
  /**
   * Creates a stream that for the next operation either delegates to a default method on {@link
   * DoubleStream}, if present for that operation, otherwise delegates to an underlying stream.
   *
   * @param s the underlying stream to be delegated to for non-default methods.
   * @return the delegating stream
   */
  ...
  /**
   * A stream that delegates the next operation to a default method, if present, or to the same
   * operation of an underlying stream.
   *
   * @param <T> the type of the stream elements
   */
