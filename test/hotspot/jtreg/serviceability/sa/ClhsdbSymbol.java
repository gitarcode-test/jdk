...
public class ClhsdbSymbol {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      // Use command "class java.lang.Thread" to get the address of the InstanceKlass for
      // java.lang.Thread
      ...
      // Extract the thread InstanceKlass address from the output, which looks similar to the
      // following:
              ...
              .orElseThrow(
                  () ->
                      new RuntimeException(
                          "Cannot find address of the InstanceKlass for java.lang.Thread in"
                              + " output"));
