...
public class HeapDumpParallelTest {
  ...
  private static void checkAndVerify(
      OutputAnalyzer dcmdOut, LingeredApp app, File heapDumpFile, boolean expectSerial)
      throws Exception {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      test(
          heapDumpFile,
          "-gz=9 -overwrite -parallel=" + Runtime.getRuntime().availableProcessors(),
          false);
    } finally {
      theApp.stopApp();
    }
  ...
  private static OutputAnalyzer attachJcmdHeapDump(
      File heapDumpFile, long lingeredAppPid, String arg) throws Exception {
