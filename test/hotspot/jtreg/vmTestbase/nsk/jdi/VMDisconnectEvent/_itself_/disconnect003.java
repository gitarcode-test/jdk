...
public class disconnect003 {
    static final int PASSED = 0;
    static final int FAILED = 2;
    static final int JCK_STATUS_BASE = 95;
    static final String COMMAND_READY = "ready";
    static final String COMMAND_QUIT  = "quit";
    static final String TEST_NAME = "nsk.jdi.VMDisconnectEvent._itself_.disconnect003";
...
//                                  log.display("Event received: " + event.toString());
                          ...
                          log.complain("TEST INCOMPLETE: caught VMInterruptedException while waiting for event");
                          testFailed = true;
                    } catch (VMDisconnectedException e) {
         ...
         log.display("Invoking VirtualMachine.exit(int) for debuggee.");
         vm.exit(disconnect003.PASSED);
