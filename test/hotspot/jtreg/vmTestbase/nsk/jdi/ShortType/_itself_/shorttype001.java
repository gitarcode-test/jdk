...
package nsk.jdi.ShortType._itself_;
 ...
 * ShortType.                                                   <BR>
 *                                                              <BR>
 * The test checks that for a mirror of a short value, the casts<BR>
 * from Type to ShortType and from PrimitiveType to ShortType   <BR>
 ...
 * - The debuggee prepares a short field and invokes                    <BR>
...
public class shorttype001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new shorttype001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            try {
                log2("      checking up on cast: ShortType shortType = (ShortType) type;");
                    shortType = (ShortType) type;
            } catch ( ClassCastException e ) {
                    testExitCode = FAILED;
                    log3("ERROR: ClassCastException");
            }
            try {
                log2("      checking up on cast: ShortType shortType = (ShortType) primitiveType;");
                    shortType = (ShortType) primitiveType;
            } catch ( ClassCastException e ) {
                    testExitCode = FAILED;
                    log3("ERROR: ClassCastException");
            }
