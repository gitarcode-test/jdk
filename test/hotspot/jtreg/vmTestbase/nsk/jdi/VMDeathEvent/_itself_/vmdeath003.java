 ...
 * <BR>
 * The case to test includes receiving no VMDeathEvent          <BR>
 * as a response to VirtualMachine.dispose();                   <BR>
 * <BR>
 ...
 * the debugger invokes the method VirtualMachine.dispose() and         <BR>
 * checks up on the event received in the response to.                  <BR>
 * <BR>
 */

public class vmdeath003 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new vmdeath003().runThis(argv, out);
    ...
    */
    ...
    private int runTest() {
        ...
        try {
            ...
            if (newEvent instanceof VMDeathEvent)  {
                testExitCode = FAILED;
                log3("ERROR: last event is the VMDeathEvent");
                return 0;
            }
            if (newEvent instanceof VMDisconnectEvent) {
                log2("......received : VMDisconnectEvent");
                return 2;
            }
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("......vm.dispose();  :: VMDeathEvent is NOT excpected");
