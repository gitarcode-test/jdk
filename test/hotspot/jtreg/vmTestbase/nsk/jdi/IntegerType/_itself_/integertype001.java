...
package nsk.jdi.IntegerType._itself_;
 ...
 * IntegerType.                                                 <BR>
 *                                                              <BR>
 * The test checks that for a mirror of an integer value the casts<BR>
 * from Type to IntegerType and from PrimitiveType to IntegerType<BR>
 ...
 * - The debuggee prepares an integer field and invokes                 <BR>
...
public class integertype001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new integertype001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            try {
                log2("      checking up on cast: IntegerType integerType = (IntegerType) type;");
            ...
            try {
                log2("      checking up on cast: IntegerType integerType = (IntegerType) primitiveType;");
                    integerType = (IntegerType) primitiveType;
            } catch ( ClassCastException e ) {
                    testExitCode = FAILED;
                    log3("ERROR: ClassCastException");
            }
