 ...
 * CharType.                                                    <BR>
 *                                                              <BR>
 * The test checks that for a mirror of a char value the casts  <BR>
 * from Type to CharType and from PrimitiveType to CharType     <BR>
 ...
 * - The debuggee prepares a char field and invokes                     <BR>
...
public class chartype001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new chartype001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            try {
                log2("      checking up on cast: CharType charType = (CharType) type;");
            ...
            try {
                log2("      checking up on cast: CharType charType = (CharType) primitiveType;");
                    charType = (CharType) primitiveType;
            } catch ( ClassCastException e ) {
                    testExitCode = FAILED;
                    log3("ERROR: ClassCastException");
            }
