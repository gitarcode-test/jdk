...
public class filters001 {
    ...
    private final static String prefix = "nsk.jdi.StepRequest._bounds_.";
    ...
    private void addInstanceFilter(StepRequest request,
    ...
    private void addClassFilter(StepRequest request, ReferenceType refType) {
    ...
    private void addClassFilter(StepRequest request, String classPattern) {
    ...
    private void addClassExclusionFilter(StepRequest request,
                                                    String classPattern) {
