 ...
 * The debugee part of the test raises own uncaught exevent003tException.
 */

public class exevent003 {
    ...
    static final String DEBUGGEE_CLASS = "nsk.jdi.ExceptionEvent._itself_.exevent003t";
    ...
    public static int run(String argv[], PrintStream out) {
        return new exevent003().runIt(argv, out);
    }
    ...
    private int runIt(String argv[], PrintStream out) {
        ...
        debuggee.redirectStderr(log, "exevent003t.err> ");
        vm = debuggee.VM();
...
/* Create a new ExceptionRequest with false notifyUncaught parameter
   so uncaught exceptions should not be reported. */
    ...
    private ExceptionRequest createExReq(boolean notifyC, boolean notifyUnc) {
        ...
        try {
            eRequest = erManager.createExceptionRequest(rType, notifyC, notifyUnc);
        } catch (Exception e) {
