 ...
 * The debugee part of the test raises uncaught StackOverflowException by
 * recursion calls of the same method.
 */

public class exevent004 {
    ...
    static final String DEBUGGEE_CLASS = "nsk.jdi.ExceptionEvent._itself_.exevent004t";
    ...
    public static int run(String argv[], PrintStream out) {
        return new exevent004().runIt(argv, out);
    }
    ...
    private int runIt(String argv[], PrintStream out) {
        ...
        debuggee.redirectStderr(log, "exevent004t.err> ");
        vm = debuggee.VM();
