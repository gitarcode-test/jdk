...
public class exevent006 {
    ...
    static final String DEBUGGEE_CLASS = "nsk.jdi.ExceptionEvent._itself_.exevent006t";
//    static final String DEBUGGEE_EXCEPTION = "java.lang.NumberFormatException";
    ...
    public static int run(String argv[], PrintStream out) {
        return new exevent006().runIt(argv, out);
    }
    ...
    private int runIt(String argv[], PrintStream out) {
        ...
        debuggee.redirectStderr(log, "exevent006t.err> ");
        vm = debuggee.VM();
