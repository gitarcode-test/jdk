 ...
 * ByteType.                                                    <BR>
 *                                                              <BR>
 * The test checks that for a mirror of a byte value the casts  <BR>
 * from Type to ByteType and from PrimitiveType to ByteType     <BR>
 ...
 * - The debuggee prepares a byte field and invokes                     <BR>
...
public class bytetype001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new bytetype001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            try {
                log2("      checking up on cast: ByteType booleanType = (ByteType) type;");
                    byteType = (ByteType) type;
            } catch ( ClassCastException e ) {
                    testExitCode = FAILED;
                    log3("ERROR: ClassCastException");
            }
            try {
                log2("      checking up on cast: ByteType byteType = (ByteType) primitiveType;");
                    byteType = (ByteType) primitiveType;
            } catch ( ClassCastException e ) {
                    testExitCode = FAILED;
                    log3("ERROR: ClassCastException");
            }
