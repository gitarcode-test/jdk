 ...
 * VoidType.                                                    <BR>
 *                                                              <BR>
 * The test checks that for a mirror of a "void" value the cast <BR>
 * from Type to VoidType doesn't throw ClassCastException.      <BR>
 * <BR>
 ...
 * <BR>
 * In second phase to check the cast,                                   <BR>
...
public class voidtype001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new voidtype001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            log2("......getting: List methods = debuggeeClass.methodsByName('testMethod');");
            List methods = debuggeeClass.methodsByName("testMethod");
            if (methods.size() != 1) {
                testExitCode = FAILED;
                log3("ERROR: methods.size() != 1");
                break ;
            }

            log2("......getting: Method testMethod = (Method) methods.get(0);");
            Method testMethod = (Method) methods.get(0);

            try {
                 log2("......getting: Type testMethodReturnType = testMethod.returnType();");
                 Type testMethodReturnType = testMethod.returnType();

                 log2("......VoidType voidType = (VoidType) testMethodReturnType;");
                 VoidType voidType = (VoidType) testMethodReturnType;
            } catch ( ClassNotLoadedException e ) {
                 log3("ERROR: testmethodReturnType = testmethod.returnType();");
                 testExitCode = FAILED;
                 break ;
