 ...
 * BooleanType.                                                 <BR>
 *                                                              <BR>
 * The test checks that for a mirror of a boolean value the casts<BR>
 * from Type to BooleanType and from PrimitiveType to BooleanType<BR>
 ...
 * - The debuggee prepares a boolean field and invokes                  <BR>
...
public class booleantype001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new booleantype001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            try {
                log2("      checking up on cast: BooleanType booleanType = (BooleanType) type;");
            ...
            try {
                log2("      checking up on cast: BooleanType booleanType = (BooleanType) primitiveType;");
                    booleanType = (BooleanType) primitiveType;
            } catch ( ClassCastException e ) {
                    testExitCode = FAILED;
                    log3("ERROR: ClassCastException");
            }
