 ...
 * DoubleType.                                                  <BR>
 *                                                              <BR>
 * The test checks that for a mirror of a double value, the casts<BR>
 * from Type to DoubleType and from PrimitiveType to DoubleType <BR>
 ...
 * - The debuggee prepares a double field and invokes                   <BR>
...
public class doubletype001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new doubletype001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            try {
                log2("      checking up on cast: DoubleType doubleType = (DoubleType) type;");
            ...
            try {
                log2("      checking up on cast: DoubleType doubleType = (DoubleType) primitiveType;");
                    doubleType = (DoubleType) primitiveType;
            } catch ( ClassCastException e ) {
                    testExitCode = FAILED;
                    log3("ERROR: ClassCastException");
            }
