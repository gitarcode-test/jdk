...
package nsk.jdi.LongType._itself_;
 ...
 * LongType.                                                    <BR>
 *                                                              <BR>
 * The test checks that for a mirror of a long value, the casts <BR>
 * from Type to LongType and from PrimitiveType to LongType     <BR>
 ...
 * - The debuggee prepares a long field and invokes                     <BR>
...
public class longtype001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new longtype001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            try {
                log2("      checking up on cast: LongType longType = (LongType) type;");
                    longType = (LongType) type;
            } catch ( ClassCastException e ) {
                    testExitCode = FAILED;
                    log3("ERROR: ClassCastException");
            }
            try {
                log2("      checking up on cast: LongType longType = (LongType) primitiveType;");
                    longType = (LongType) primitiveType;
            } catch ( ClassCastException e ) {
                    testExitCode = FAILED;
                    log3("ERROR: ClassCastException");
            }
