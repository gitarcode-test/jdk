...
/**
 * This class is used as debuggee application for the arguments001 JDI test.
 */

public class arguments001a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> arguments001a: " + message);
    }
    ...
    static arguments001aTestClass obj = new arguments001aTestClass();
