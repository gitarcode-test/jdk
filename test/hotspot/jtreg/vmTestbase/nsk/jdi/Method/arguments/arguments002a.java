...
/**
 * This class is used as debuggee application for the arguments002 JDI test.
 */

public class arguments002a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> arguments002a: " + message);
    }
    ...
    static arguments002aTestClass obj = new arguments002aTestClass();
