...
/**
 * This class is used as debuggee application for the alllinelocations002JDI test.
 */

public class alllinelocations002a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> alllinelocations002a: " + message);
    }
