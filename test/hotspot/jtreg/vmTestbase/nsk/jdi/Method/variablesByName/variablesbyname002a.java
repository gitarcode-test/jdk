...
/**
 * This class is used as debuggee application for the variablesbyname002 JDI test.
 */

public class variablesbyname002a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> variablesbyname002a: " + message);
    }
    ...
    static variablesbyname002aTestClass obj = new variablesbyname002aTestClass();
