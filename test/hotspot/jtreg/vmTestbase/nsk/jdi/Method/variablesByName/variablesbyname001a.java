...
/**
 * This class is used as debuggee application for the variablesbyname001 JDI test.
 */

public class variablesbyname001a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> variablesbyname001a: " + message);
    }
    ...
    static variablesbyname001aTestClass obj = new variablesbyname001aTestClass();
...
class variablesbyname001aTestClass {
