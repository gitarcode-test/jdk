...
public class argumenttypes002a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> argumenttypes002a: " + message);
    }
    ...
    static argumenttypes002aTestClass obj = new argumenttypes002aTestClass();
...
class argumenttypes002aTestClass {
   ...
   public void primitiveargsmethod ( boolean bl,
    ...
    public argumenttypes002aClassForCheck1 classargmethod (argumenttypes002aClassForCheck1 classFC) {
        return classFC;
    }
    public argumenttypes002aIntfForCheck ifaceargmethod (argumenttypes002aIntfForCheck iface) {
        return iface;
    }
...
class argumenttypes002aClassForCheck2 implements argumenttypes002aIntfForCheck {
}

class argumenttypes002aClassForCheck1 {
