...
/**
 * This class is used as debuggee application for the returntypenames001 JDI test.
 */

public class returntypenames001a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> returntypenames001a: " + message);
    }
    ...
    static returntypenames001aTestClass obj = new returntypenames001aTestClass();
