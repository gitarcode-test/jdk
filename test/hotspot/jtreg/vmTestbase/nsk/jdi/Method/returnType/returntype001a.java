...
/**
 * This class is used as debuggee application for the returntype001 JDI test.
 */

public class returntype001a {
    ...
    private static void log1(String message) {
        if (verbMode)
            System.err.println("**> returntype001a: " + message);
    }
    ...
    static returntype001aTestClass obj = new returntype001aTestClass();
