...
class Class1ForCheck {
    ...
    public Class2ForCheck classMethod() {
        classObj = new Class2ForCheck();
        return classObj;
    }
...
class Class2ForCheck implements IfaceForCheck {
