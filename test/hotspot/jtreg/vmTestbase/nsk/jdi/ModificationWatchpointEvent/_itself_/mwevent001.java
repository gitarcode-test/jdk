 ...
 * ModificationWatchpointEvent.                                 <BR>
 *                                                              <BR>
 * The test checks that results of methods in the interface     <BR>
 * <code>com.sun.jdi.ModificationWatchpointEvent</code>         <BR>
 * complies with its spec.                                      <BR>
 * <BR>
 * The test checks up on the following assertion:               <BR>
 *    The number of ModificationWatchpointEvents received is    <BR>
 *    equal to the number of ModificationWatchpointRequests     <BR>
 *    set up by a debugger.                                     <BR>
 * <BR>
 ...
 * - The debuggee creates an object foo of CheckedClass and invokes     <BR>
 ...
 *   - set up enabled ModificationWatchpointRequests for all fields,    <BR>
 *   - resumes the debuggee, and                                        <BR>
 *   - waiting for all expected events to receive.                      <BR>
 * <BR>
...
public class mwevent001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new mwevent001().runThis(argv, out);
