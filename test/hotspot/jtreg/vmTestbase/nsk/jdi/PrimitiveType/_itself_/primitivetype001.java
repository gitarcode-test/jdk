 ...
 * PrimitiveType.                                               <BR>
 * <BR>
 * The test checks up that for each PrimitiveType value the cast<BR>
 * from Type to PrimitiveType doesn't throw ClassCastException. <BR>
 * <BR>
 ...
 * - The debuggee prepares objects of all PrimitiveTypes and invokes    <BR>
...
public class primitivetype001 extends JDIBase {
    ...
    public static int run (String argv[], PrintStream out) {
        ...
        int exitCode = new primitivetype001().runThis(argv, out);
    ...
    */
    ...
    //------------------------------------------------------  testing section
        ...
        for (int i = 0; ; i++) {
            ...
            String types[] = { "BooleanType", "ByteType",    "CharType", "DoubleType",
                               "FloatType",   "IntegerType", "LongType", "ShortType"   };

            String names[] = { "bl", "bt", "ch", "db", "fl", "in", "ln", "sh" };
