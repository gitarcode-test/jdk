...
public class cm01t006 extends DebugeeClass {

    // load native library if required
    static {
        loadLibrary("cm01t006");
    }
    ...
    public static int run(String argv[], PrintStream out) {
        return new cm01t006().runIt(argv, out);
    }
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        thread = new cm01t006Thread("Debuggee Thread");
...
class cm01t006Thread extends Thread {
    public Object startingMonitor = new Object();
    private Object waitingMonitor = new Object();

    public cm01t006Thread(String name) {
        super(name);
    }
    ...
    public void run() {
        synchronized (waitingMonitor) {
            ...
            // wait on monitor
            try {
                waitingMonitor.wait(cm01t006.timeout);
