...
public class cm01t012 extends DebugeeClass {

    // load native library if required
    static {
        loadLibrary("cm01t012");
    }
    ...
    public static int run(String argv[], PrintStream out) {
        return new cm01t012().runIt(argv, out);
    }
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        thread = new cm01t012Thread("Debuggee Thread");
...
class cm01t012Thread extends Thread {
    public Object startingMonitor = new Object();
    private Object waitingMonitor = new Object();

    public cm01t012Thread(String name) {
        super(name);
    }
    ...
    public void run() {
        synchronized (waitingMonitor) {
            ...
            // wait on monitor
            try {
                waitingMonitor.wait(cm01t012.timeout);
