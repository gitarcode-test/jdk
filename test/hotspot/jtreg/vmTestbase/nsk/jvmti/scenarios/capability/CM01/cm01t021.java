...
public class cm01t021 extends DebugeeClass {
    ...
    public static int run(String argv[], PrintStream out) {
        return new cm01t021().runIt(argv, out);
    }
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        thread = new cm01t021Thread("Debuggee Thread");
...
class cm01t021Thread extends Thread {
    public Object startingMonitor = new Object();
    private Object waitingMonitor = new Object();

    public cm01t021Thread(String name) {
        super(name);
    }
    ...
    public void run() {
        synchronized (waitingMonitor) {
            ...
            // wait on monitor
            try {
                waitingMonitor.wait(cm01t021.timeout);
