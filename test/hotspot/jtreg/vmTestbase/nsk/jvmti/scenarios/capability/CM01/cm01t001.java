...
public class cm01t001 extends DebugeeClass {

    // load native library if required
    static {
        loadLibrary("cm01t001");
    }
    ...
    public static int run(String argv[], PrintStream out) {
        return new cm01t001().runIt(argv, out);
    }
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        thread = new cm01t001Thread("Debuggee Thread");
...
//        log.display("Testing sync: checkStatus");
...
class cm01t001Thread extends Thread {
    public Object startingMonitor = new Object();
    private Object waitingMonitor = new Object();

    public cm01t001Thread(String name) {
        super(name);
    }
    ...
    public void run() {
        synchronized (waitingMonitor) {
            ...
            // wait on monitor
            try {
                waitingMonitor.wait(cm01t001.timeout);
