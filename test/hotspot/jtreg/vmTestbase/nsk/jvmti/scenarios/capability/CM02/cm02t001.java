...
package nsk.jvmti.scenarios.capability.CM02;
...
public class cm02t001 extends DebugeeClass {
    ...
    public static int run(String argv[], PrintStream out) {
        return new cm02t001().runIt(argv, out);
    }
    ...
    public int runIt(String argv[], PrintStream out) {
        ...
        thread = new cm02t001Thread("Debuggee Thread");
...
class cm02t001Thread extends Thread {
    ...
    public void run() {
        synchronized (waitingMonitor) {
            ...
            // wait on monitor
            try {
                waitingMonitor.wait(cm02t001.timeout);
