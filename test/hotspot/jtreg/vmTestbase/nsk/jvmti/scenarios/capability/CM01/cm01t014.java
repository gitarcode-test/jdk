...
public class cm01t014 extends DebugeeClass {

    // load native library if required
    static {
        loadLibrary("cm01t014");
    }
    ...
    public static int run(String argv[], PrintStream out) {
        return new cm01t014().runIt(argv, out);
    }
...
class cm01t014Thread extends Thread {
    public Object startingMonitor = new Object();
    private Object waitingMonitor = new Object();

    public cm01t014Thread(String name) {
        super(name);
    }
    ...
    public void run() {
        synchronized (waitingMonitor) {
            ...
            // wait on monitor
            try {
                waitingMonitor.wait(cm01t014.timeout);
