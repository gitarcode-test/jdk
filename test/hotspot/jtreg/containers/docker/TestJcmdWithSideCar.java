...
public class TestJcmdWithSideCar {
  ...
  private static long testCase01() throws Exception {
    OutputAnalyzer out =
        runSideCar(MAIN_CONTAINER_NAME, "/jdk/bin/jcmd", "-l")
  ...
  private static OutputAnalyzer runSideCar(
      String mainContainerName, String whatToRun, String... args) throws Exception {
    List<String> cmd = new ArrayList<>();
    String[] command =
        new String[] {
          Container.ENGINE_COMMAND,
          "run",
          "--tty=true",
          "--rm",
          "--cap-add=SYS_PTRACE",
  ...
  static class MainContainer {
    ...
    public Process start() throws Exception {
      ...
      p = ProcessTools.startProcess("main-container-process", pb, outputConsumer);
      return p;
    }
    ...
    public void assertIsAlive() throws Exception {
      if (!p.isAlive()) {
        throw new RuntimeException(
            "Main container process stopped unexpectedly, exit value: " + p.exitValue());
      }
    }
    ...
    public void waitForAndCheck(long timeout) throws Exception {
      ...
      if (exitValue != 0) {
        throw new RuntimeException(
            "DockerThread stopped unexpectedly, non-zero exit value is " + exitValue);
      }
    }
  }
}
