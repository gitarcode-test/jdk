...
public class SymbolTable {
  ...
  private static final Stack<HashMap<Type, ArrayList<Symbol>>> SYMBOL_STACK = new Stack<>();
  ...
  protected static Collection<Symbol> get(TypeKlass typeKlass, Type type, Class<?> classToCheck) {
    HashMap<Type, ArrayList<Symbol>> vars = SYMBOL_STACK.peek();
    if (vars.containsKey(type)) {
  ...
  protected static HashMap<Type, ArrayList<Symbol>> getAll(
      TypeKlass typeKlass, Class<?> classToCheck) {
    HashMap<Type, ArrayList<Symbol>> result = new HashMap<>();
