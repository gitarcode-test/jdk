 ...
 * @build BasicLambdaApp jdk.test.whitebox.WhiteBox LambdaVerification
 * @run driver jdk.test.lib.helpers.ClassFileInstaller -jar basic_lambda_app.jar BasicLambdaApp LambdaVerification
