 ...
 * @library /test/lib /
 * @requires vm.compMode != "Xint" & vm.flavor == "server" & (vm.opt.TieredStopAtLevel == null |
 *     vm.opt.TieredStopAtLevel == 4) & vm.debug == true
...
public class UseCountedLoopSafepointsTest {
  ...
  private static class Node {
    ...
    public Node(String name, String str) {
      ...
      // parse string like: " $id    $name       ===  $to1 $to2 ...   [[ $from1 $from2 ... ]]
      // $anything"
