...
public class TestStringIntrinsics2 {
  ...
  @Test(
      role = Role.TEST_HELPER,
      compileAt = 4,
      warmup = 1,
      warmupArgs = {"<t><t><t>", "<miss>"})
  ...
  static String indexOf_reads_past_string_imm_needle(String s) {
    ...
    if (index > s.length()) {
      return "Found needle \"<hit>\" behind string of length "
          + s.length()
          + " at position "
          + index
          + ".";
  ...
  static String indexOf_reads_past_string_imm2_needle(String s) {
    ...
    if (index > s.length()) {
      return "Found needle \"<h\" behind string of length "
          + s.length()
          + " at position "
          + index
          + ".";
  ...
  @Test(
      ...
      compileAt = 4,
      warmup = 1,
      warmupArgs = {"<t><hi><t><h><hit<t><hit>", "<hit>"})
  ...
  public static void test_asmStringCompareTo() {
    ...
    try {
      ...
      assertTrue(false, "TestOther.asmStringCompareTo(\"not null\", null) doesn't throw exception");
    ...
    // ==0
    {
      ...
      assertEquals(0, asmStringCompareTo("", ""), "TestOther.asmStringCompareTo(\"\", \"\")");

      // check first character optimization
      assertEquals(0, asmStringCompareTo("A", "A"), "TestOther.asmStringCompareTo(\"A\", \"A\")");

      // check real comparisons
      assertEquals(
          0,
          asmStringCompareTo(new String("eq") + new String("ual"), "equal"),
          "TestOther.asmStringCompareTo(\"equal\", \"equal\")");
      assertEquals(
          0,
          asmStringCompareTo("textABC", "textABC"),
          "TestOther.asmStringCompareTo(\"textABC\", \"textABC\")");
      assertEquals(
          0,
          asmStringCompareTo(
              new String("abcdefgh01234") + new String("56abcdefgh0123456abcdefgh0123456"),
    ...
    {
      // check first character optimization
      assertEquals(-1, asmStringCompareTo("4", "5"), "TestOther.asmStringCompareTo(\"4\", \"5\")");

      // check real comparisons
      assertEquals(
          -1,
          asmStringCompareTo("diff4", "diff5"),
          "TestOther.asmStringCompareTo(\"diff4\", \"diff5\")");
      assertEquals(
          -10,
          asmStringCompareTo("", "123456789A"),
          "TestOther.asmStringCompareTo(\"\", \"123456789A\")");
      assertEquals(
          -10,
          asmStringCompareTo("ZYX", "ZYX123456789A"),
    ...
    {
      // check first character optimization
      assertEquals(1, asmStringCompareTo("5", "4"), "TestOther.asmStringCompareTo(\"5\", \"4\")");

      // check real comparisons
      assertEquals(
          1,
          asmStringCompareTo("diff5", "diff4"),
    ...
    // very long strings (100k)
    {
      ...
      for (int i = 0; i < (100 * 1024); i += 315) ac[i] = (char) ((i % 12) + 'a');
      char[] bc = new char[(100 * 1024)];
      for (int i = 0; i < (100 * 1024); i += 315) bc[i] = (char) ((i % 12) + 'a');
      ...
      assertEquals(
          0, asmStringCompareTo(a1, b1), "TestOther.asmStringCompareTo(very_long_strings_1)");
      ...
      assertEquals(
          -2, asmStringCompareTo(a2, b2), "TestOther.asmStringCompareTo(very_long_strings_2)");
    }

    // very very long strings (2M)
    {
      char[] ac = new char[(2 * 1024 * 1024)];
      for (int i = 0; i < (2 * 1024 * 1024); i += 315) ac[i] = (char) ((i % 12) + 'a');
      char[] bc = new char[(2 * 1024 * 1024)];
      for (int i = 0; i < (2 * 1024 * 1024); i += 315) bc[i] = (char) ((i % 12) + 'a');
      ...
      String b1 = new String(bc);
      assertEquals(
          0, asmStringCompareTo(a1, b1), "TestOther.asmStringCompareTo(very_very_long_strings_1)");
      ...
      String b2 = new String(bc);
      assertEquals(
          -3, asmStringCompareTo(a2, b2), "TestOther.asmStringCompareTo(very_very_long_strings_2)");
    }
  ...
  public static void test_asmStringEquals() {
    ...
    {
      assertFalse(
          asmStringEquals("not null", null), "TestOther.asmStringEquals(\"not null\", null)");
    }

    // true
    {
      // check constant optimization
      assertTrue(asmStringEqualsConst(), "TestOther.asmStringEqualsConst(\"\", \"\")");

      // check length 0 optimization
      assertTrue(asmStringEquals("", ""), "TestOther.asmStringEquals(\"\", \"\")");

      // check first character optimization
      assertTrue(asmStringEquals("A", "A"), "TestOther.asmStringEquals(\"A\", \"A\")");

      // check real comparisons
      assertTrue(
          asmStringEquals(new String("eq") + new String("ual"), "equal"),
          "TestOther.asmStringEquals(\"equal\", \"equal\")");
      assertTrue(
          asmStringEquals("textABC", "textABC"),
