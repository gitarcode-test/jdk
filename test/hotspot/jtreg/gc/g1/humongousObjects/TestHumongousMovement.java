 ...
 *     -Xbootclasspath/a:. -XX:G1HeapRegionSize=1M -Xms200m -Xmx200m
 *     -XX:InitiatingHeapOccupancyPercent=100 -Xlog:gc=info:file=TestHumongousMovement.log
...
public class TestHumongousMovement {
  ...
  private static class AllocationData {
    ...
    public boolean isAddressChanged() {
      return !new BigInteger(Long.toUnsignedString((WB.getObjectAddress(allocation))))
    ...
    public void printDetails(PrintStream out) {
      ...
      out.println(
          String.format(
              "Object stored address = %d\nObject address after GC = %d\n" + "They are %sequals",
              objectAddress,
              objectAddressAfterGC,
              !objectAddress.equals(objectAddressAfterGC) ? "not " : ""));
    }
  }
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Allocating " + regionsToAllocate + " humongous objects, each 90% of g1 region size");
    ...
    Asserts.assertGreaterThan(
        hSize, g1RegionSize / 2, "Test Bug: allocation size is not humongous");
