...
<meta name="description" content="declaration: module: mA, package: pA, class: CA">""");
  ...
  final Set<String> allBodyClasses =
      Set.of(
  ...
  final Set<String> allGenerators =
      Set.of(
  ...
  void checkMetadata(Path p) {
    ...
    List<String> generators =
        nl.splitAsStream(readOutputFile(p.toString()))
    ...
    switch (s) {
      case PACKAGES:
        tb.writeJavaFiles(
            ...
            "/** Serializable pA.Ser, */ package pA; public class Ser implements"
                + " java.io.Serializable { }",
            "/** Package pB. */ package pB;",
            "/** Class pB.CB. */ package pB; public class CB { }");
        tb.writeFile(
            src.resolve("pA").resolve("doc-files").resolve("extra.html"),
            """
            <!doctype html>
