...
public class Helper {
  ...
  public static boolean compileCode(
      String className, String contents, DiagnosticCollector<JavaFileObject> diagnostics) {
    boolean ok = false;
  ...
  public static boolean compileCode(
      DiagnosticCollector<JavaFileObject> diagnostics, Iterable<? extends JavaFileObject> files) {
  ...
  private static boolean isPkgInfoPresent(Iterable<? extends JavaFileObject> files) {
  ...
  /* String template where /*<TYPE>*/
  /*gets replaced by repeating anno
