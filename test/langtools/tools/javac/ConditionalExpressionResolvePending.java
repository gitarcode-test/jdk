...
public class ConditionalExpressionResolvePending
    extends ComboInstance<ConditionalExpressionResolvePending> {
  ...
  public enum Snippet implements ComboParameter {
    ...
    SWITCH_EXPRESSION(
        "switch (len) { case 16 -> {boolean r = true; yield r; } default -> {boolean r = false;"
            + " yield r; } }"),
    SWITCH_EXPRESSION_STRING(
        "switch (clazzName) { case \"java.lang.String\"-> {boolean r = true; yield r; } default ->"
            + " {boolean r = false; yield r; } }");
