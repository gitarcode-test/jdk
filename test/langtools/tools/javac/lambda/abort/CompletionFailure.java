...
public class CompletionFailure {
    ...
    JavacTask ct =
        (JavacTask)
            javacTool.getTask(
                ...
                null,
                null,
                Arrays.asList(sourceA.asJFO(scratchDir), sourceB.asJFO(scratchDir)));
    ...
    ct =
        (JavacTask)
            javacTool.getTask(
                ...
                null,
                Arrays.asList(sourceC.asJFO(scratchDir), sourceD.asJFO(scratchDir)));
    try {
      ct.analyze();
    } catch (Throwable ex) {
  ...
  static class JavaSource {
    ...
    JavaFileObject asJFO(java.io.File dir) {
      return SimpleJavaFileObject.forSource(new File(dir, filename).toURI(), contents);
    }
  }

  static JavaSource sourceA = new JavaSource("A.java", "public interface A { }\n");

  static JavaSource sourceB =
      new JavaSource(
          "B.java",
  ...
  static JavaSource sourceC =
      new JavaSource(
          "C.java",
          "public class C {\n" + "   void test(B b) {\n" + "      D.m(B.n());\n" + "}  }\n");

  static JavaSource sourceD =
      new JavaSource("D.java", "public class D {\n" + "   static void m(Object o) { }\n" + "}\n");
