...
public class T7042566 extends ComboInstance<T7042566> {
  ...
  enum TypeKind {
    ...
    boolean isSubtypeOf(TypeKind that) {
      return that == OBJECT || (that == STRING && this == STRING);
    }
  }
  ...
  public static void main(String[] args) {
    new ComboTestHelper<T7042566>()
        .withArrayDimension(
            "SIG", (x, sig, idx) -> x.methodSignatures[idx] = sig, 2, TypeConfiguration.values())
  ...
  ComboParameter getMethodDecl(String parameterName) {
    switch (parameterName) {
      case "METH":
        return optParameter -> {
          return optParameter.equals("1") ? m1.toString() : m2.toString();
        };
      default:
        return null;
    }
