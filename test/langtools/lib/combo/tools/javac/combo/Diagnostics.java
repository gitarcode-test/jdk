...
/**
 * A container for compiler diagnostics, separated into errors and warnings, used by
 * JavacTemplateTestBase.
 *
 * @author Brian Goetz
 */
public class Diagnostics implements javax.tools.DiagnosticListener<JavaFileObject> {
  ...
  public List<String> keys() {
    return diags.stream().map(Diagnostic::getCode).collect(toList());
  }
