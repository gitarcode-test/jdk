...
public class WhiteBox {
   ...
   *
   * <p>The returned WhiteBox object should be carefully guarded by the caller, since it can be used
   * to read and write data at arbitrary memory addresses. It must never be passed to untrusted
   * code.
   */
  ...
  private native Object[] parseCommandLine0(
      String commandline, char delim, DiagnosticCommand[] args);
   ...
   * @return long[3] array where long[0] - total count of old regions long[1] - total memory of old
   *     regions long[2] - lowest estimation of total memory of old regions to be freed (non-full
  ...
  public boolean isIntrinsicAvailable(
      Executable method, Executable compilationContext, int compLevel) {
    Objects.requireNonNull(method);
  ...
  private native boolean isIntrinsicAvailable0(
      Executable method, Executable compilationContext, int compLevel);
  ...
  private native boolean enqueueMethodForCompilation0(
      Executable method, int compLevel, int entry_bci);
  ...
  public native int stressVirtualSpaceResize(
  ...
  // Jigsaw
  public native void DefineModule(
      Object module, boolean is_open, String version, String location, Object[] packages);
  ...
  private final List<BiFunction<Executable, String, Object>> methodOptionGetters =
      Arrays.asList(
          this::getMethodBooleanOption,
          this::getMethodIntxOption,
          this::getMethodUintxOption,
          this::getMethodDoubleOption,
  ...
  public native int validateCgroup(
      String procCgroups, String procSelfCgroup, String procSelfMountinfo);
